...
var nothing_should_be_rebuilt=[0,/* false */0];

var sanitize=[0,/* true */1];

var sanitization_script=[0,"sanitize.sh"];

var hygiene=[0,/* true */1];

var ignore_auto=[0,/* true */1];

var plugin=[0,/* true */1];

var just_plugin=[0,/* false */0];

var native_plugin=[0,/* true */1];

var make_links=[0,/* true */1];

var nostdlib=[0,/* false */0];

var use_menhir=[0,/* false */0];

var catch_errors=[0,/* true */1];

var use_ocamlfind=[0,/* false */0];
...
var must_clean=[0,/* false */0];

var show_documentation=[0,/* false */0];

var recursive=[0,/* false */0];
             ...
             /* :: */[0,
              ...
              /* :: */[0,
               /* tuple */[0,
                "-I",
                /* String */[4,
                 function(param){return add_to$prime(my_include_dirs,param)}],
                "<path> Add to include directories"],
               /* :: */[0,
                /* tuple */[0,
                 "-Is",
                 /* String */[4,
                  function(param){return add_to(my_include_dirs,param)}],
                 "<path,...> (same as above, but accepts a (comma or blank)-separated list)"],
                /* :: */[0,
                 /* tuple */[0,
                  "-X",
                  /* String */[4,
                   function(param){return add_to$prime(my_exclude_dirs,param)}],
                  "<path> Directory to ignore"],
                 /* :: */[0,
                  /* tuple */[0,
                   "-Xs",
                   /* String */[4,
                    function(param){return add_to(my_exclude_dirs,param)}],
                   "<path,...> (idem)"],
                  /* :: */[0,
                   /* tuple */[0,
                    "-lib",
                    /* String */[4,
                     function(param)
                      {return add_to$prime(ocaml_libs_internal,param)}],
                    "<flag> Link to this ocaml library"],
                   /* :: */[0,
                    /* tuple */[0,
                     "-libs",
                     /* String */[4,
                      function(param){return add_to(ocaml_libs_internal,param)}],
                     "<flag,...> (idem)"],
                    /* :: */[0,
                     /* tuple */[0,
                      "-mod",
                      /* String */[4,
                       function(param)
                        {return add_to$prime(ocaml_mods_internal,param)}],
                      "<module> Link to this ocaml module"],
                     /* :: */[0,
                      /* tuple */[0,
                       "-mods",
                       /* String */[4,
                        function(param){return add_to(ocaml_mods_internal,param)}],
                       "<module,...> (idem)"],
                      /* :: */[0,
                       /* tuple */[0,
                        "-pkg",
                        /* String */[4,
                         function(param)
                          {return add_to$prime(ocaml_pkgs_internal,param)}],
                        "<package> Link to this ocaml findlib package"],
                       /* :: */[0,
                        /* tuple */[0,
                         "-pkgs",
                         /* String */[4,
                          function(param){return add_to(ocaml_pkgs_internal,param)}],
                         "<package,...> (idem)"],
                        /* :: */[0,
                         /* tuple */[0,
                          "-package",
                         ...
                         /* :: */[0,
                          ...
                          /* :: */[0,
                           /* tuple */[0,
                            ...
                            /* String */[4,
                             function(param)
                              {return add_to$prime(ocaml_lflags_internal,param)}],
                            "<flag> Add to ocamlc link flags"],
                           /* :: */[0,
                            /* tuple */[0,
                             "-lflags",
                             /* String */[4,
                              function(param){return add_to(ocaml_lflags_internal,param)}],
                             "<flag,...> (idem)"],
                            /* :: */[0,
                             /* tuple */[0,
                              "-cflag",
                              /* String */[4,
                               function(param)
                                {return add_to$prime(ocaml_cflags_internal,param)}],
                              "<flag> Add to ocamlc compile flags"],
                             /* :: */[0,
                              /* tuple */[0,
                               "-cflags",
                               /* String */[4,
                                function(param){return add_to(ocaml_cflags_internal,param)}],
                               "<flag,...> (idem)"],
                              /* :: */[0,
                               /* tuple */[0,
                                "-docflag",
                                /* String */[4,
                                 function(param)
                                  {return add_to$prime(ocaml_docflags_internal,param)}],
                               ...
                               /* :: */[0,
                                /* tuple */[0,
                                 ...
                                 /* String */[4,
                                  function(param)
                                   {return add_to(ocaml_docflags_internal,param)}],
                                 "<flag,...> (idem)"],
                                /* :: */[0,
                                 /* tuple */[0,
                                  "-yaccflag",
                                  /* String */[4,
                                   function(param)
                                    {return add_to$prime(ocaml_yaccflags_internal,param)}],
                                 ...
                                 /* :: */[0,
                                  /* tuple */[0,
                                   ...
                                   /* String */[4,
                                    function(param)
                                     {return add_to(ocaml_yaccflags_internal,param)}],
                                   "<flag,...> (idem)"],
                                  /* :: */[0,
                                   /* tuple */[0,
                                    "-lexflag",
                                    /* String */[4,
                                     function(param)
                                      {return add_to$prime(ocaml_lexflags_internal,param)}],
                                   ...
                                   /* :: */[0,
                                    /* tuple */[0,
                                     ...
                                     /* String */[4,
                                      function(param)
                                       {return add_to(ocaml_lexflags_internal,param)}],
                                     "<flag,...> (idem)"],
                                    /* :: */[0,
                                     /* tuple */[0,
                                      "-ppflag",
                                      /* String */[4,
                                       function(param)
                                        {return add_to$prime(ocaml_ppflags_internal,param)}],
                                      "<flag> Add to ocaml preprocessing flags"],
                                     /* :: */[0,
                                      /* tuple */[0,
                                       "-pp",
                                       /* String */[4,
                                        function(param){return add_to(ocaml_ppflags_internal,param)}],
                                       "<flag,...> (idem)"],
                                      /* :: */[0,
                                       /* tuple */[0,
                                        "-tag",
                                        /* String */[4,
                                         function(param){return add_to$prime(tags_internal,param)}],
                                        "<tag> Add to default tags"],
                                       /* :: */[0,
                                        /* tuple */[0,
                                         "-tags",
                                         /* String */[4,
                                          function(param){return add_to(tags_internal,param)}],
                                         "<tag,...> (idem)"],
                                        /* :: */[0,
                                         /* tuple */[0,
                                          "-plugin-tag",
                                          /* String */[4,
                                           function(param)
                                            {return add_to$prime(plugin_tags_internal,param)}],
                                          "<tag> Use this tag when compiling the myocamlbuild.ml plugin"],
                                         /* :: */[0,
                                          /* tuple */[0,
                                           "-plugin-tags",
                                           /* String */[4,
                                            function(param){return add_to(plugin_tags_internal,param)}],
                                           "<tag,...> (idem)"],
                                          /* :: */[0,
                                           /* tuple */[0,
                                            "-tag-line",
                                            /* String */[4,
                                             function(param)
                                              {return add_to$prime(tag_lines_internal,param)}],
                                           ...
                                           /* :: */[0,
                                            /* tuple */[0,
                                             ...
                                             /* String */[4,
                                              function(param)
                                               {return add_to$prime(show_tags_internal,param)}],
                                             "<path> Show tags that applies on that pathname"],
                                            /* :: */[0,
                                             /* tuple */[0,
                                              "-ignore",
                                              /* String */[4,
                                               function(param){return add_to(ignore_list_internal,param)}],
...
var
 init=
  function(param)
   {var
     anon_fun=
      function(param$1){return add_to$prime(targets_internal,param$1)};
