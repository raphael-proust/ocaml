 ...
 execute=
  function
   ...
   {var $js$4=$staropt$star;
    ...
    var $js$6=$staropt$star$2;
    if($js$6){var period=$staropt$star$2[1]}else{var period=0.1}
    var $js$7=$staropt$star$3;
    if($js$7)
     {var display=$staropt$star$3[1]}
    else
     ...
     add_job=
      function(cmd,rest,result,id)
       {var $js$12=Unix["open_process_full"];
        ...
        var $js$14=doi(stdout$prime);
        $js$13($js$14);
        var $js$15=Unix["set_nonblock"];
        var $js$16=doi(stderr$prime);
        $js$15($js$16);
        var $js$17=Buffer["create"];
        var $js$18=$js$17(1024);
        var
         job=
          [0,id,cmd,rest,result,stdout$prime,match[2],stderr$prime,$js$18,0];
        var $js$19=FDM[4];
        var $js$20=doi(stdout$prime);
        var $js$21=FDM[4];
        var $js$22=doi(stderr$prime);
    ...
    var
     terminate=
      function($staropt$star$4,job)
       {var $js$12=$staropt$star$4;
        if($js$12){var $$continue=$staropt$star$4[1]}else{var $$continue=1}
        var $js$13=!job[9];
        if($js$13)
         {job[9]=1,0;
          var $js$14=Queue["add"];
    ...
    var
     do_read=
      function($staropt$star$4,fd,job)
       {var $js$12=$staropt$star$4;
        if($js$12){var loop=$staropt$star$4[1]}else{var loop=0}
        try
         {var
           iteration=
            function(param)
