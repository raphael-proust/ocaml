   ...
   {var ext_lib=Options["ext_lib"][1];
    ...
    Rule["rule"]
     ("ocaml: ml & cmi -> cmo",
      ...
      0,
      0,
      Ocaml_compiler["byte_compile_ocaml_implem"](0,"%.ml","%.cmo"));
    Rule["rule"]
    ...
    Rule["rule"]
     ("ocaml: ml & cmi -> cmx & o",
      ...
      0,
      0,
      Ocaml_compiler["native_compile_ocaml_implem"](0,0,"%.ml"));
    Rule["rule"]
     ("ocaml: ml -> d.cmo & cmi",
      0,
      [0,[0,"%.d.cmo",0]],
    ...
    Rule["rule"]
     ("ocaml: p.cmxa & p.a -> p.cmxs & p.so",
      ...
      0,
      Ocaml_compiler["native_shared_library_link"]
       ([0,[0,"profile",[0,"linkall",0]]],"%.p.cmxa","%.p.cmxs"));
    Rule["rule"]
     ("ocaml: cmx & o -> cmxs",
      0,
      [0,[0,"%.cmxs",0]],
      ...
      Ocaml_compiler["native_shared_library_link"](0,"%.cmx","%.cmxs"));
    Rule["rule"]
     ("ocaml: cmx & o -> cmxs & so",
      0,
      [/* Some */0,[/* :: */0,"%.cmxs",[/* :: */0,x_dll,0]]],
    ...
    Rule["rule"]
     ("preprocess: ml -> pp.ml",
      ...
      Ocaml_tools["camlp4"](0,"pp.ml","%.ml","%.pp.ml"));
    Flags["flag"]
     (0,
      [0,"ocaml",[0,"pp",0]],
      [/* S */0,
    ...
    Flags["flag"]
     (0,[0,"c",[0,"link",0]],Command["atomize"](Options["ocaml_lflags"][1]));
    Flags["flag"]
     (0,
    ...
    Flags["flag"]
     (0,[0,"ocaml",[0,"menhir",[0,"infer",0]]],[0,[0,[1,"--infer"],0]]);
    var
     match=
      My_std["List"][14]
       (function(mode)
    ...
    if(Options["use_ocamlfind"][1])
     {My_std["&"]
       (Flags["flag"](0,[0,"ocaml",[0,"link",[0,"program",0]]]),
        [1,"-linkpkg"]);
      My_std["&"]
       (Flags["flag"](0,[0,"ocaml",[0,"link",[0,"toplevel",0]]]),
        [1,"-linkpkg"]);
      My_std["&"]
       (Flags["flag"](0,[0,"ocaml",[0,"link",[0,"output_obj",0]]]),
        [1,"-linkpkg"]);
      My_std["&"]
       (Flags["flag"](0,[0,"ocaml",[0,"link",[0,"linkpkg",0]]]),
        [1,"-linkpkg"]);
      Flags["pflag"]
       ([0,"ocaml",[0,"link",0]],
        "dontlink",
    ...
    camlp4_flags$prime
     ([0,
       ...
       [0,
        ...
        0]]);
    Flags["flag"]
     (0,[0,"ocaml",[0,"pp",[0,"camlp4:no_quot",0]]],[1,"-no_quot"]);
    Ocaml_utils["ocaml_lib"]([0,1],0,0,0,0,"dynlink");
    Ocaml_utils["ocaml_lib"]([0,1],0,0,0,0,"unix");
    Ocaml_utils["ocaml_lib"]([0,1],0,0,0,0,"str");
    Ocaml_utils["ocaml_lib"]([0,1],0,0,0,0,"bigarray");
    Ocaml_utils["ocaml_lib"]([0,1],0,0,0,0,"nums");
    Ocaml_utils["ocaml_lib"]([0,1],0,0,0,0,"dbm");
    Ocaml_utils["ocaml_lib"]([0,1],0,0,0,0,"graphics");
    Ocaml_utils["ocaml_lib"]([0,1],0,0,0,[0,"use_toplevel"],"toplevellib");
    Ocaml_utils["ocaml_lib"]([0,1],0,0,[0,"+ocamldoc"],0,"ocamldoc");
    Ocaml_utils["ocaml_lib"]
     ([0,1],0,0,[0,"+ocamlbuild"],[0,"use_ocamlbuild"],"ocamlbuildlib");
    Ocaml_utils["ocaml_lib"]
     ([0,1],0,0,[0,"+camlp4"],[0,"use_camlp4"],"camlp4lib");
    Ocaml_utils["ocaml_lib"]
     ([0,1],0,0,[0,"+camlp4"],[0,"use_old_camlp4"],"camlp4");
    Ocaml_utils["ocaml_lib"]
     ([0,1],0,0,[0,"+camlp4"],[0,"use_camlp4_full"],"camlp4fulllib");
    Flags["flag"]
     (0,
    ...
    Flags["flag"]
     (0,[0,"ocaml",[0,"debug",[0,"compile",[0,"byte",0]]]],[1,"-g"]);
    Flags["flag"]
     (0,
      [0,"ocaml",[0,"debug",[0,"link",[0,"byte",[0,"program",0]]]]],
      [1,"-g"]);
    Flags["flag"](0,[0,"ocaml",[0,"debug",[0,"pack",[0,"byte",0]]]],[1,"-g"]);
    Flags["flag"]
     (0,[0,"ocaml",[0,"debug",[0,"compile",[0,"native",0]]]],[1,"-g"]);
    Flags["flag"]
     (0,
      [0,"ocaml",[0,"debug",[0,"link",[0,"native",[0,"program",0]]]]],
      [1,"-g"]);
    Flags["flag"]
     (0,[0,"ocaml",[0,"debug",[0,"pack",[0,"native",0]]]],[1,"-g"]);
    Flags["flag"](0,[0,"c",[0,"debug",[0,"compile",0]]],[1,"-g"]),
    Flags["flag"](0,[0,"c",[0,"debug",[0,"link",0]]],[1,"-g"]),
    Flags["flag"]
     (0,
    ...
    Flags["flag"]
     (0,
      ...
      [1,"-output-obj"]);
    My_std["&"]
     (Flags["flag"](0,[0,"ocaml",[0,"link",[0,"output_shared",0]]]),
      [0,[0,[1,"-cclib"],[0,[1,"-shared"],0]]]);
    Flags["flag"](0,[0,"ocaml",[0,"dtypes",[0,"compile",0]]],[1,"-dtypes"]);
    Flags["flag"](0,[0,"ocaml",[0,"annot",[0,"compile",0]]],[1,"-annot"]);
    Flags["flag"](0,[0,"ocaml",[0,"annot",[0,"pack",0]]],[1,"-annot"]);
    Flags["flag"]
     (0,[0,"ocaml",[0,"bin_annot",[0,"compile",0]]],[1,"-bin-annot"]);
    Flags["flag"](0,[0,"ocaml",[0,"bin_annot",[0,"pack",0]]],[1,"-bin-annot"]);
    Flags["flag"]
    ...
    Flags["flag"]
     (0,
      ...
      [1,"-short-paths"]);
    Flags["flag"]
     (0,[0,"ocaml",[0,"rectypes",[0,"compile",0]]],[1,"-rectypes"]);
    Flags["flag"]
     (0,[0,"ocaml",[0,"rectypes",[0,"infer_interface",0]]],[1,"-rectypes"]);
    Flags["flag"](0,[0,"ocaml",[0,"rectypes",[0,"doc",0]]],[1,"-rectypes"]);
    Flags["flag"](0,[0,"ocaml",[0,"rectypes",[0,"pack",0]]],[1,"-rectypes"]);
    Flags["flag"]
     (0,[0,"ocaml",[0,"principal",[0,"compile",0]]],[1,"-principal"]);
    Flags["flag"]
     (0,[0,"ocaml",[0,"principal",[0,"infer_interface",0]]],[1,"-principal"]);
    Flags["flag"](0,[0,"ocaml",[0,"linkall",[0,"link",0]]],[1,"-linkall"]);
    Flags["flag"]
     (0,[0,"ocaml",[0,"link",[0,"profile",[0,"native",0]]]],[1,"-p"]);
    Flags["flag"]
     (0,
    ...
    Flags["flag"]
     (0,
      ...
      [1,"-custom"]);
    Flags["flag"]
     (0,[0,"ocaml",[0,"compile",[0,"profile",[0,"native",0]]]],[1,"-p"]);
    Flags["flag"]
    ...
    Flags["flag"]
     (0,[0,"ocaml",[0,"compile",[0,"keep_docs",0]]],[1,"-keep-docs"]),
    Flags["flag"]
     (0,[0,"ocaml",[0,"compile",[0,"keep_locs",0]]],[1,"-keep-locs"]),
    Flags["flag"](0,[0,"ocaml",[0,"absname",[0,"compile",0]]],[1,"-absname"]);
    Flags["flag"]
    ...
    Flags["flag"]
     (0,
      ...
      [1,"-compat-32"]),
    Flags["flag"](0,[0,"ocaml",[0,"compile",[0,"thread",0]]],[1,"-thread"]);
    Flags["flag"](0,[0,"ocaml",[0,"link",[0,"thread",0]]],[1,"-thread"]);
    if(!Options["use_ocamlfind"][1])
     {Flags["flag"]
       (0,
    ...
    Flags["flag"]
     (0,[0,"ocaml",[0,"compile",[0,"nolabels",0]]],[1,"-nolabels"]);
    Flags["flag"](0,[0,"ocaml",[0,"ocamllex",[0,"quiet",0]]],[1,"-q"]);
    var
     ocaml_warn_flag=
      function(c)
       {Flags["flag"]
    ...
    Flags["flag"]
     (0,[0,"ocaml",[0,"doc",[0,"docdir",[0,"manpage",0]]]],[1,"-man"]);
    Flags["flag"]
    ...
    Flags["flag"]
     (0,
      ...
      [1,"-texi"]);
    Ocaml_utils["ocaml_lib"](0,0,0,0,0,"ocamlbuildlib");
    Ocaml_utils["ocaml_lib"](0,0,0,0,0,"ocamlbuildlightlib");
    var
     M=
      [0,
       ext_lib,
