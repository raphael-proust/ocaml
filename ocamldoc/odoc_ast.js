         ...
         {var match=pat_exp_list[1];
          ...
          if(pat_exp_list[2])
           ...
           {var
             ...
             {case 0:
               switch(parameter$1[1][1])
                {case "*opt*":
                  ...
                  switch(exit$1)
                   {case 331:var match$3=/* tuple */[0,parameter$1,func_body];}
            ...
            switch(exit)
             {case 332:var match$3=/* tuple */[0,parameter$1,func_body];}
               ...
               if(pat_exp_list[2])
                ...
                {if(!first)
                  {var
                    ...
                    {case 0:
                      switch(parameter[1][1])
                       {case "*opt*":
                         ...
                         switch(exit$1)
                          {case 303:var match$4=/* tuple */[0,parameter,body];}
                   ...
                   switch(exit)
                    {case 304:var match$4=/* tuple */[0,parameter,body];}
