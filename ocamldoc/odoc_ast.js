      ...
      function(cpt,param)
       {if(param)
         {var match=param[1][1];
          ...
          switch(match[0])
           {case 0:return n===cpt?match[2]:iter(cpt+1,param[2]);
 ...
 iter=
  function(param)
   {var exit;
    ...
    switch(param[0])
     {case 0:exit=347;break;case 1:return param[1];case 2:exit=347;break}
               ...
               {case 0:
                ...
                case 4:
                 ...
                 if(typeof match$1==="number")
                  ...
                  {switch(match$1[0])
                    {case 3:
                      $js=Path["same"](match$1[1],Predef["path_unit"]);break;
                     default:exit$1=336;}}
                 
                 var $js$1;
                 switch(exit$1){case 336:$js$1=/* false */0;break}
                 if($js$1)
                  {return /* Simple_name */[0,
                           /* record */[0,
                            "()",
       ...
       {var match=clexp[1];
        ...
        switch(match[0])
         {case 0:return Odoc_name["from_path"](match[1]);
          case 3:exit=312;break;
          case 5:exit=312;break;
    ...
    var
     tt_analyse_method_expression=
      function(env,current_method_name,comment_opt,$staropt$star,exp)
       {var first=$staropt$star?$staropt$star[1]:/* true */1;
                            ...
                            if(match$4)
                             {var match$5=match$4[1];
                              ...
                              if(typeof match$6==="number")
                               ...
                               {switch(match$6[0])
                                 {case 0:
                                   var name=Odoc_name["from_ident"](match$6[1]);
             ...
             {var q=param[2];
              ...
              switch(match[0])
               {case 0:
                 ...
                 var tt_clexp;
                 try
                  {tt_clexp=Typedtree_search[13](tt_cls,n);}
                 catch(exn)
                  {if(exn===CamlPrimitive["caml_global_data"]["Not_found"])
                    {throw [0,
                            CamlPrimitive["caml_global_data"]["Failure"],
                 ...
                 var text_opt=info_opt?info_opt[1][1]:/* None */0;
                ...
                case 1:
                 ...
                 var type_exp;
                 try
                  {type_exp=Typedtree_search[14](tt_cls,label);}
                 catch(exn$1)
                 ...
                 switch(match$4[3][0])
                  {case 0:
                   ...
                   case 1:
                    ...
                    var exp;
                    try
                     {exp=Typedtree_search[16](tt_cls,label$1);}
                    catch(exn$3)
                        ...
                        if(match$8)
                         {var match$9=match$8[1];
                          ...
                          if(typeof match$10==="number")
                           ...
                           {switch(match$10[0])
                             {case 0:
                               var name$1=Odoc_name["from_ident"](match$10[1]);
                               ...
                               var
                                new_param=
                                 /* Simple_name */[0,
                                  /* record */[0,
                                   name$1,
                                   Odoc_env["subst_type"](env,match$9[2][4]),
                                   Odoc_parameter["desc_from_info_opt"](comment_opt,name$1)]];
                               
                               match$6=/* tuple */[0,new_param,match$7[4]];
                               break;
                              default:exit$4=251;}}
                          }
                        else
          ...
          function(env,last_pos,param)
           {if(param)
             {var q=param[2];
              ...
              var pos_limit2=q?q[1][2][1][4]:pos_limit;
        ...
        switch(parsetree_item_desc[0])
         {case 0:return /* tuple */[0,0,env,/* [] */0];
                     ...
                     var
                      match$1=
                       first
                        ...
                        :get_comments_in_module(last_pos,pat[2][1][4]);
              ...
              {var first=$staropt$star?$staropt$star[1]:/* false */0;
               ...
               if(name_type_decl_list)
                {var q=name_type_decl_list[2];
                 ...
                 var tt_type_decl;
                 try
                  {tt_type_decl=Typedtree_search[8](table,name$1);}
                 catch(exn)
                  {if(exn===CamlPrimitive["caml_global_data"]["Not_found"])
                    {throw [0,
                            CamlPrimitive["caml_global_data"]["Failure"],
          ...
          case 4:
           ...
           if(match$2)
            {var ext=match$2[1];
             ...
             try
              {tt_tyext=Typedtree_search[6](table,ext[1][1]);}
             catch(exn)
              {if(exn===CamlPrimitive["caml_global_data"]["Not_found"])
                {throw [0,
                        CamlPrimitive["caml_global_data"]["Failure"],
          ...
          case 5:
           ...
           var tt_ext;
           try
            {tt_ext=Typedtree_search[7](table,name$1[1]);}
           catch(exn$1)
            {if(exn$1===CamlPrimitive["caml_global_data"]["Not_found"])
              {throw [0,
                      CamlPrimitive["caml_global_data"]["Failure"],
            ...
            {var tt_module_expr=Typedtree_search[4](table,name$2[1]);
             ...
             if(Odoc_global["keep_code"][1])
              {var loc$1=module_expr[2];
               ...
               code$1=/* Some */[0,get_string_of_file(st,en)];
               }
             else
              {code$1=/* None */0;}
             ...
             List["fold_left"]
              (function(acc_env,param)
                {var name$3=param[1];
                 ...
                 var tt_mod_exp;
                 try
                  {tt_mod_exp=Typedtree_search[4](table,name$3[1]);}
                 catch(exn$3)
                  {if(exn$3===CamlPrimitive["caml_global_data"]["Not_found"])
                    {throw [0,
                            CamlPrimitive["caml_global_data"]["Failure"],
                ...
                {var match$7=name_mod_exp_list[1];
                 ...
                 var
                  match$8=
                   first
                    ?/* tuple */[0,comment_opt,/* [] */0]
                    :get_comments_in_module(last_pos,loc_start$2);
          ...
          case 8:
           ...
           var tt_module_type;
           try
            {tt_module_type=Typedtree_search[5](table,name$3[1]);}
           catch(exn$3)
            {if(exn$3===CamlPrimitive["caml_global_data"]["Not_found"])
              {throw [0,
                      CamlPrimitive["caml_global_data"]["Failure"],
              ...
              {var first=$staropt$star?$staropt$star[1]:/* false */0;
               ...
               if(class_decl_list)
                {var class_decl=class_decl_list[1];
                 ...
                 var match$12;
                 try
                  {match$12=Typedtree_search[9](table,class_decl[3][1]);}
                 catch(exn$4)
          ...
          case 13:exit=148;break;
          case 14:exit=148;break
          }
          ...
          case 2:
           switch(match$2[0])
            {case 2:
              ...
              var loc$1=pmodule_type$1?pmodule_type$1[1][2]:Location["none"];
              ...
              var
               param=
                /* record */[0,
                 mp_name,
                 Misc["may_map"]
                  (function(m){return Odoc_env["subst_module_type"](env,m[2])},
                   mtyp),
                 mp_type_code,
                 mp_kind];
