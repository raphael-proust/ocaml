   ...
   {var
    ...
    CamlinternalOO["set_methods"]
     ($$class,
      [0,
        ...
        {if($staropt$star){var no_=$staropt$star[1];}else{var no_=1;}
         ...
         for(var i=0;i<=len-1;i++)
          {var c=name[i];
           ...
           switch(exit)
            {case 106:
              var match=[0,$$String["make"](1,c),$$String["make"](1,c)];
             }
       ...
       make_label,
       function(self$neg1,label$1)
        {return Pervasives["^"]("\label{",Pervasives["^"](label$1,"}"));},
       make_ref,
       function(self$neg1,label$1)
        {return Pervasives["^"]("\ref{",Pervasives["^"](label$1,"}"));},
       latex_of_text,
           ...
           if("unknown primitive:isint")
            {if("unknown primitive:isint")
             ...
             if(text_opt)
              ...
              {var text=[0,[1,Odoc_info["use_hidden_modules"](name)],0];}
    ...
    return function(env,$$self)
     {var $$self$1=CamlinternalOO["create_object_opt"]($$self,$$class);
      ...
      List["map"]
       (function(param){return [0,Str["regexp"](param[1]),param[2]];},
        [0,
         [0,"\x01","\x01\x02"],
         [0,
          [0,"\\","\x01b"],
      ...
      [0,
       ...
       function(self$neg3,fmt,m_name,t)
        {var
          print_one=
           function(param)
            {ps(fmt,Odoc_info["string_of_variance"](t,[0,param[2],param[3]]));
                     ...
                     List["map"]
                      (function(r)
                        {"unknown block:(sendself self-3/1738 normal_type/1726 mod_name/1745 (field 1 r/1758))";
                         ...
                         return Pervasives["@"]
                                 ([0,[2,s_field],0],entry_comment(r[3]));
                         },
                       match$8[1]);
                ...
                List["map"]
                 (function(constr)
                   {p
                    ...
                    return Pervasives["@"]
                            ([0,[2,s_cons],0],entry_comment(constr[4]));
                    },
                  match$6[1]);
                ...
                List["map"]
                 (function(r)
                   {"unknown block:(sendself self-3/1738 normal_type/1726 mod_name/1745 (field 2 r/1769))";
                    ...
                    return Pervasives["@"]
                            ([0,[2,s_field],0],entry_comment(r[4]));
                    },
                  match$6[1]);
              ...
              (function(x)
                {var father=Odoc_info["Name"][5](x[1]);
                 ...
                 if(match$5)
                  ...
                  {var $js=0;}
                 return Pervasives["@"]([0,[14,0],[0,[2,s_cons],0]],$js);
                 },
               te[5]));
       ...
       latex_of_module_parameter,
       function(self$neg3,fmt,m_name,p$1)
         ...
         var
          t=
           [0,
            ...
            [0,
             [1,"module "],
             [0,[1,Odoc_info["Name"][1](m[1])],[0,[1," : "],0]]]];
        ...
        {var father=Odoc_info["Name"][5](mt[1]);
         ...
         var
          t=
           [0,
            [14,"\begin{ocamldoccode}\n"],
            [0,[1,"module type "],[0,[1,Odoc_info["Name"][1](mt[1])],0]]];
             ...
             if(match)
              {switch(match[1])
               ...
               return [0,
                       0,
                       [0,
                        [1,Pervasives["^"]("inherit ",inh$3[1])],
                        [0,
                         [14,Pervasives["^"](" [",Pervasives["^"](0,"]"))],
            ...
            text$1=
             [0,
              [13,
               1,
               0,
               Pervasives["@"]([0,[0,m[1]],0],first_t?[0,[0," : "],first_t]:0)],
              0];
           }
         else
          {var
