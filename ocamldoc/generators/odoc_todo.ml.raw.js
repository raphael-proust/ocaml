...
var
 scanner_init=
  function(class)
   {var $js$3=CamlinternalOO["new_variable"];
    var html=$js$3(class,"");
    var $js$4=CamlinternalOO["new_methods_variables"];
    var ids=$js$4(class,shared$3,shared$2);
    ...
    var inh=$js$5(class,0,0,shared$6,Odoc_info["Scan"][1],1);
    var obj_init=inh[1];
    ...
    $js$6
     (class,
      [0,
       ...
       b,
       gen_if_tag,
       function(self-1,name,target,info_opt)
        {var $js$7=info_opt;
         if($js$7)
                       ...
                       if($js$12==1)
                        {try
                          {var n="unknown primitive:caml_int_of_string";
                           ...
                           var
                            $js$14=
                             $js$13([0,[12,91,[4,0,0,0,[11,"] ",0]]],"[%d] "],n);
                           var head=[1,$js$14];
             ...
             $js$11
              (function(param)
                {var $js$12=Printf["bprintf"];
                 ...
                 return p
                         (self-1[b],[0,[11,"</span><br/>\n",0],"</span><br/>\n"])},
               l$1);
             return p(self-1[b],[0,[11,"</div>",0],"</div>"])}
           else
            {return 0}}
         else
          {return 0}},
       ...
       function(self-1,m)
        {var $js$7=List["iter"];
         var $js$8=Odoc_module["module_elements"];
         var $js$9=$js$8([0,0],m);
         return $js$7
                 (function(ele)
                   {var $js$10=ele;
                  ...
                  $js$9)},
       scan_included_module,
       function(self-1,param){return 0},
       scan_class_pre,
       function(self-1,c)
    ...
    return function(env,self,html$1)
     {var $js$7=CamlinternalOO["create_object_opt"];
      ...
      self$1[html]=html$1,0;
      obj_init(self$1);
      var $js$8=Buffer["create"];
      var $js$9=$js$8(256);
      self$1[b]=$js$9,0;
      var $js$10=CamlinternalOO["run_initializers_opt"];
      return $js$10(self,self$1,class)}};
...
var
 html_init=
  function(class)
   {var $js$4=CamlinternalOO["new_methods_variables"];
    var ids=$js$4(class,shared$5,shared$4);
    var print_header=ids[1];
    var generate=ids[2];
    var scanner$1=ids[3];
    var $js$5=CamlinternalOO["inherits"];
    var inh=$js$5(class,shared$1,0,shared,Html[1],1);
    var obj_init=inh[1];
    var tag_functions=inh[2];
    var generate$1=inh[27];
    var $js$6=CamlinternalOO["set_method"];
    $js$6
     (class,
      generate,
      function(self-2,modules)
       {self-2[tag_functions]=
        [0,[0,"todo",function(param){return ""}],self-2[tag_functions]],
        0;
        generate$1(self-2,modules);
        var match$2=Odoc_info["Global"][6][1];
        var $js$7=match$2;
        if($js$7){var title=match$2[1]}else{var title=""}
        var $js$8=Buffer["create"];
        var b=$js$8(512);
        ...
        var $js$9=Buffer["add_buffer"];
        "unknown block:(send (array.unsafe_get self-2/1537 scanner/1534) -795558656)";
        $js$9(b,$js$10);
        var $js$11=Pervasives["open_out"];
        var $js$12=Filename["concat"];
        var $js$13=$js$12(Odoc_info["Global"][5][1],"todo.html");
        var oc=$js$11($js$13);
        var $js$14=Buffer["output_buffer"];
        $js$14(oc,b);
    ...
    $js$7
     (class,
      function(self-2)
       {var $js$8=scanner[1];
        var $js$9=$js$8(0,self-2);
        return self-2[scanner$1]=$js$9,0});
    return function(env,self)
     {var $js$8=CamlinternalOO["create_object_opt"];
      ...
      var $js$10=Html[1][1];
      var $js$11=$js$10(0);
      var $js$12=$js$9(0,$js$11);
      self$1[scanner$1]=$js$12,0;
      var $js$13=CamlinternalOO["run_initializers_opt"];
      return $js$13(self,self$1,class)}};
var $js$4=CamlinternalOO["make_class"];
var
 html=
  $js$4
   ([0,
...
var $js$5=Odoc_args["set_generator"];
$js$5([0,[0,Generator[2]]]);
