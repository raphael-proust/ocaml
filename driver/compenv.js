   ...
   {var match=Clflags["output_name"][1];
    ...
    if(match)
     {if(Clflags["compile_only"][1])
       {Clflags["output_name"][1]=0,0;var oname=match[1];}
      else
       {var oname=name;}
      }
    else
...
var
 print_version_and_library=
  function(compiler)
   {Printf["printf"]
     ([0,[11,"The OCaml ",[2,0,[11,", version ",0]]],"The OCaml %s, version "],
      compiler);
 ...
 module_of_filename=
  function(ppf,inputfile,outputprefix)
   {var basename=Filename["basename"](outputprefix);
    ...
    catch(exn){if(exn=Not_found){var name=basename;}else{throw exn;}}
...
var $$SyntaxError="unknown primitive:caml_set_oo_id";
 ...
 parse_args=
  function(s)
   {var args=Misc["split"](s,44);
    ...
    var
     iter=
      function(is_after,args$1,before,after)
       {if(args$1)
         {var arg=args$1[1];
          ...
          switch(arg)
           {case "_":
             if(is_after)
              ...
              {return iter(1,args$1[2],before,after);}
  ...
  function(ppf,f,name,options,s)
   {try
     {var exit;
      ...
      switch(s){case "0":var bool=0;case "1":var bool=1;default:exit=25;}
      
      switch(exit){case 25:throw Not_found;}
       ...
       {return Location["print_warning"]
                (Location["none"],
                 ...
                 /* Bad_env_variable */[29,
                  "OCAMLPARAM",
                  Printf["sprintf"]
                   ([0,[11,"bad value for ",[2,0,0]],"bad value for %s"],name)]);
        }
      else
       {throw exn;}
      }
...
var
 read_OCAMLPARAM=
  function(ppf,position)
   {try
     {var s="unknown primitive:caml_sys_getenv";
      ...
      var
       set=
        function(name,options,s$1)
         {return setter(ppf,function(b){return b;},name,options,s$1);};
                ...
                {var v=param[2];
                 ...
                 switch(name)
                  {case "I":
                   ...
                   case "S":
                    return set("S",/* :: */[0,Clflags["keep_asm_file"],0],v);
                   case "absname":
                    return set("absname",/* :: */[0,Location["absname"],0],v);
                   case "annot":
                    return set("annot",/* :: */[0,Clflags["annotations"],0],v);
                   case "bin-annot":
                    return set
                            ("bin-annot",/* :: */[0,Clflags["binary_annotations"],0],v);
                   ...
                   case "compact":
                    return clear
                            ("compact",/* :: */[0,Clflags["optimize_for_speed"],0],v);
                   ...
                   case "dstartup":
                    return set
                            ("dstartup",/* :: */[0,Clflags["keep_startup_file"],0],v);
                    
                   case "g":return set("g",/* :: */[0,Clflags["debug"],0],v);
                   case "inline":
                    try
                     ...
                     {return Location["print_warning"]
                              (Location["none"],
                               ppf,
                               [29,"OCAMLPARAM",'non-integer parameter for "inline"']);
                      }
                    
                   case "intf-suffix":return Config["interface_suffix"][1]=v,0;
                   case "keep-docs":
                    return set("keep-docs",/* :: */[0,Clflags["keep_docs"],0],v);
                    
                   case "keep-locs":
                    return set("keep-locs",/* :: */[0,Clflags["keep_locs"],0],v);
                    
                   case "linkall":
                    return set
                            ("linkall",/* :: */[0,Clflags["link_everything"],0],v);
                   ...
                   case "noassert":
                    return set("noassert",/* :: */[0,Clflags["noassert"],0],v);
                   case "noautolink":
                    return set
                            ("noautolink",/* :: */[0,Clflags["no_auto_link"],0],v);
                    
                   case "nodynlink":
                    return clear("nodynlink",/* :: */[0,Clflags["dlcode"],0],v);
                   case "nolabels":
                    return set("nolabels",/* :: */[0,Clflags["classic"],0],v);
                   case "nopervasives":
                    return set
                            ("nopervasives",/* :: */[0,Clflags["nopervasives"],0],v);
                    
                   case "nostdlib":
                    return set
                            ("nostdlib",/* :: */[0,Clflags["no_std_include"],0],v);
                   ...
                   case "principal":
                    return set("principal",/* :: */[0,Clflags["principal"],0],v);
                    
                   case "rectypes":
                    return set
                            ("rectypes",/* :: */[0,Clflags["recursive_types"],0],v);
                   ...
                   case "safe-string":
                    return clear
                            ("safe-string",/* :: */[0,Clflags["unsafe_string"],0],v);
                    
                   case "short-paths":
                    return clear
                            ("short-paths",/* :: */[0,Clflags["real_paths"],0],v);
                    
                   case "slash":
                    return set("slash",/* :: */[0,Clflags["force_slash"],0],v);
                   case "strict-formats":
                    return set
                            ("strict-formats",/* :: */[0,Clflags["strict_formats"],0],v);
                   ...
                   case "thread":
                    return set("thread",/* :: */[0,Clflags["use_threads"],0],v);
                   case "trans-mod":
                    return set
                            ("trans-mod",/* :: */[0,Clflags["transparent_modules"],0],v);
                    
                   case "unsafe":
                    return set("unsafe",/* :: */[0,Clflags["fast"],0],v);
                   case "verbose":
                    return set("verbose",/* :: */[0,Clflags["verbose"],0],v);
                   case "w":exit=15;
                 ...
                 switch(exit)
                  {case 15:return Warnings["parse_options"](0,v);
                   case 14:
                    if(!List["mem"](name,can_discard[1]))
                     {can_discard[1]=/* :: */[0,name,can_discard[1]],0;
                      return Printf["eprintf"]
                              ([0,
                                [11,
                                 "Warning: discarding value of variable ",
                                 [3,0,[11," in OCAMLPARAM\n",[10,0]]]],
                   ...
                   case 11:return Warnings["parse_options"](1,v);
                   case 12:
...
var
 readenv=
  function(ppf,position)
   {last_include_dirs[1]=0,0;
    last_ccopts[1]=0,0;
    last_ppx[1]=0,0;
    last_objfiles[1]=0,0;
    read_OCAMLPARAM(ppf,position);
    Clflags["all_ccopts"][1]=
    Pervasives["@"](last_ccopts[1],first_ccopts[1]),
    0;
