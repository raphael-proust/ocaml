     ...
     {var $js$3=__ocaml_lex_state$1;
      ...
      if($js$4==0)
       {var $js$5=Lexing["sub_lexeme"];
        return $js$5(lexbuf,lexbuf[5],lexbuf[10][0])}
      else
       if($js$4==1)
        {var $js$6=Lexing["lexeme"];return $js$6(lexbuf)}
       else
        if($js$4==2){return "unknown primitive:raise"}}};
   ...
   {var $js=Lexing["engine"];
    ...
    if($js$1)
     ...
     {var $js$3=__ocaml_lex_state$1;
      var $js$4=$js$3[0];
      if($js$4==0)
       {var $js$5=Lexing["lexeme"];var $js$6=$js$5(lexbuf);return [0,$js$6]}
      else
       if($js$4==1)
        {return argument(lexbuf)}
       else
        if($js$4==2)
         {return 11}
        else
         if($js$4==3){return "unknown primitive:raise"}}};
var
 line_argument=
  ...
  function(lexbuf,__ocaml_lex_state)
   {var $js=Lexing["engine"];
    ...
    if($js$1)
     ...
     {var $js$4=Lexing["lexeme"];var $js$5=$js$4(lexbuf);return [0,$js$5]}};
...
var
 __ocaml_lex_lexeme_rec=
  function(lexbuf,__ocaml_lex_state)
   {var $js=Lexing["engine"];
    var __ocaml_lex_state$1=$js(__ocaml_lex_tables,__ocaml_lex_state,lexbuf);
    var $js$1=18<__ocaml_lex_state$1>>>0;
    if($js$1)
     {var $js$2=lexbuf[1];
      $js$2(lexbuf);
     ...
     {var $js$3=__ocaml_lex_state$1;
      ...
      if($js$4==0)
       ...
       if($js$4==1)
        {var $js$5=Lexing["lexeme"];var $js$6=$js$5(lexbuf);return [1,$js$6]}
       else
        if($js$4==2)
         {var $js$7=Lexing["lexeme"];var $js$8=$js$7(lexbuf);return [2,$js$8]}
        else
         if($js$4==3)
          {var $js$9=Lexing["lexeme"];
           var s=$js$9(lexbuf);
           var $js$10=String["sub"];
           var $js$11=$js$10(s,1,s["length"]-2);
           return [1,$js$11]}
         else
          if($js$4==4)
           {var $js$12=Lexing["lexeme"];
            var $js$13=$js$12(lexbuf);
            var $js$14="unknown primitive:caml_int64_of_string";
            return [4,$js$14]}
          else
           if($js$4==5)
            {return 0}
                     ...
                     if($js$4==15)
                      ...
                      if($js$4==16)
                       ...
                       if($js$4==17)
                        ...
                        if($js$4==18){return "unknown primitive:raise"}}};
module["exports"]=
{"line":line,
 "lexeme":lexeme,
 "argument":argument,
