  ...
  [function(param){var $js=Pervasives["failwith"];return $js("parser")},
   ...
   function(__caml_parser_env)
    {var $js=Parsing["peek_val"];
     ...
     var $js$1=Parsing["peek_val"];
     var _3=$js$1(__caml_parser_env,0);
     return [1,_1,_3]},
   function(__caml_parser_env)
    {var $js=Parsing["peek_val"];
     var _1=$js(__caml_parser_env,0);
   ...
   function(__caml_parser_env)
    {var $js=Parsing["peek_val"];
     var _2=$js(__caml_parser_env,2);
     var $js$1=Parsing["peek_val"];
     var _3=$js$1(__caml_parser_env,1);
     var $js$2=Parsing["peek_val"];
     var _4=$js$2(__caml_parser_env,0);
     var $js$3=Int64ops["to_int"];
     var $js$4=$js$3(_3);
     var $js$5=[2,_2,$js$4,_4];
     return $js$5},
   function(__caml_parser_env)
    {var $js=Parsing["peek_val"];
     var _2=$js(__caml_parser_env,2);
     var $js$1=Parsing["peek_val"];
     var _4=$js$1(__caml_parser_env,0);
     return [3,_2,_4]},
   function(__caml_parser_env)
    {var $js=Parsing["peek_val"];
     var _1=$js(__caml_parser_env,2);
     ...
     var $js$2=Parsing["peek_val"];
     var _3=$js$2(__caml_parser_env,0);
     return [0,_1,[0,_2],_3]},
   function(__caml_parser_env)
    {var $js=Parsing["peek_val"];
     var _1=$js(__caml_parser_env,0);
     return [0,_1,0,0]},
   function(__caml_parser_env)
    {var $js=Input_handling["stop_user_input"];var $js$1=$js(0);return $js$1},
   function(__caml_parser_env)
    {var $js=Parsing["peek_val"];
...
var
 integer_eol=
  function(lexfun,lexbuf)
   {var $js=Parsing["yyparse"];return $js(yytables,4,lexfun,lexbuf)};
var
 int64_eol=
  function(lexfun,lexbuf)
   {var $js=Parsing["yyparse"];return $js(yytables,5,lexfun,lexbuf)};
var
 integer=
  function(lexfun,lexbuf)
   {var $js=Parsing["yyparse"];return $js(yytables,6,lexfun,lexbuf)};
var
 opt_integer_eol=
  function(lexfun,lexbuf)
   {var $js=Parsing["yyparse"];return $js(yytables,7,lexfun,lexbuf)};
var
 opt_signed_integer_eol=
  function(lexfun,lexbuf)
   {var $js=Parsing["yyparse"];return $js(yytables,8,lexfun,lexbuf)};
var
 opt_signed_int64_eol=
  function(lexfun,lexbuf)
   {var $js=Parsing["yyparse"];return $js(yytables,9,lexfun,lexbuf)};
var
 identifier=
  function(lexfun,lexbuf)
   {var $js=Parsing["yyparse"];return $js(yytables,10,lexfun,lexbuf)};
var
 identifier_eol=
  function(lexfun,lexbuf)
   {var $js=Parsing["yyparse"];return $js(yytables,11,lexfun,lexbuf)};
var
 identifier_or_eol=
  function(lexfun,lexbuf)
   {var $js=Parsing["yyparse"];return $js(yytables,12,lexfun,lexbuf)};
var
 opt_identifier=
  function(lexfun,lexbuf)
   {var $js=Parsing["yyparse"];return $js(yytables,13,lexfun,lexbuf)};
var
 opt_identifier_eol=
  function(lexfun,lexbuf)
   {var $js=Parsing["yyparse"];return $js(yytables,14,lexfun,lexbuf)};
var
 expression_list_eol=
  function(lexfun,lexbuf)
   {var $js=Parsing["yyparse"];return $js(yytables,15,lexfun,lexbuf)};
var
 break_argument_eol=
  function(lexfun,lexbuf)
   {var $js=Parsing["yyparse"];return $js(yytables,16,lexfun,lexbuf)};
var
 list_arguments_eol=
  function(lexfun,lexbuf)
   {var $js=Parsing["yyparse"];return $js(yytables,17,lexfun,lexbuf)};
var
 end_of_line=
  function(lexfun,lexbuf)
   {var $js=Parsing["yyparse"];return $js(yytables,18,lexfun,lexbuf)};
var
 longident_eol=
  function(lexfun,lexbuf)
   {var $js=Parsing["yyparse"];return $js(yytables,19,lexfun,lexbuf)};
var
 opt_longident=
  function(lexfun,lexbuf)
   {var $js=Parsing["yyparse"];return $js(yytables,20,lexfun,lexbuf)};
var
 opt_longident_eol=
  function(lexfun,lexbuf)
   {var $js=Parsing["yyparse"];return $js(yytables,21,lexfun,lexbuf)};
module["exports"]=
