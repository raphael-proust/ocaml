...
var $js=match;
if($js=="Win32"){var shell="cmd"}else{var shell="/bin/sh"}
var runtime_program="ocamlrun";
var history_size=[0,30];
var $js$1=Hashtbl["create"];
var load_path_for=$js$1(0,7);
var $js$2=Int64ops["~~"];
var $js$3=$js$2("10000");
var checkpoint_big_step=[0,$js$3];
var $js$4=Int64ops["~~"];
var $js$5=$js$4("1000");
var checkpoint_small_step=[0,$js$5];
var checkpoint_max_count=[0,15];
var match$1=Sys["os_type"];
var $js$6=match$1;
if($js$6=="Win32"){var $js$7=0}else{var $js$7=1}
var make_checkpoints=[0,$js$7];
var environment=[0,0];
module["exports"]=
{"Toplevel":Toplevel,
