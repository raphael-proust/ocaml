...
var
 exit=
  function(param)
   {var $js="unknown primitive:thread_self";
    return "unknown primitive:thread_kill"};
 ...
 wait_timed_read=
  function(fd,delay$1)
   {var match=wait_timed_read_aux([0,fd,delay$1]);
    ...
    if($js)
     {var $js$1=match>=3;if($js$1){return 1}else{var exit$1=14}}
    else
     {var exit$1=14}
 ...
 wait_timed_write=
  function(fd,delay$1)
   {var match=wait_timed_write_aux([0,fd,delay$1]);
    var $js="unknown primitive:isint";
    if($js)
     {var $js$1=match>=3;if($js$1){return 1}else{var exit$1=12}}
    else
     {var exit$1=12}
 ...
 wait_pid=
  function(pid)
   {var match=wait_pid_aux(pid);
    ...
    switch(exit$1)
     {case 9:
       var $js$2=Pervasives["invalid_arg"];return $js$2("Thread.wait_pid")
      }};
var
 wait_signal=
  function(sigs)
