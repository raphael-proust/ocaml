...
var
 disjoint=
  function(s1,s2)
   {try
     {for(var i=0;i<=31;i++){if((s1[i]&s2[i])!==0){throw Pervasives["Exit"]}}
...
var
 expand=
  function(s)
   {var r=Bytes["make"](256,0);iter(function(c){return r[c]=1,0},s);return r};
...
var extract=function(buf){flush(buf);return /* Seq */[3,List["rev"](buf[2])]};
   ...
   {var len=s["length"];
    ...
    for(var i$1=0;i$1<=len-1;i$1++)
     {var c=s["charCodeAt"](i$1);
      ...
      if(31<switcher>>>0)
       {var switcher$1=27+switcher;
        ...
        if(10<switcher$1>>>0)
         ...
         {switch(switcher$1)
           {case 0:exit=46;break;
            case 1:exit=47;break;
            case 2:exit=47;break;
            case 3:exit=47;break;
            case 4:exit=47;break;
            case 5:exit=47;break;
            case 6:exit=46;break;
            case 7:exit=46;break;
            case 8:exit=47;break;
            case 9:exit=47;break;
            case 10:exit=46;break
            }
          }
        }
      else
      ...
      switch(exit)
       {case 47:buf[pos]=c;pos=pos+1;break;
        case 46:buf[pos]=92;buf[pos+1]=c;pos=pos+2;break
        }
      }
    
    return Bytes["sub_string"](buf,0,pos)};

var regexp_string=function(s){return compile(/* false */0,/* String */[1,s])};
