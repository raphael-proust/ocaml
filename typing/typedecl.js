  ...
  function(env,sdecl,id)
   {var match=sdecl[6];
    ...
    var
     decl=
      /* record */[0,
       List["map"](function(param){return Btype["newgenvar"](0,0);},sdecl[2]),
       List["length"](sdecl[2]),
       0,
       sdecl[5],
       match?/* Some */[0,Ctype["newvar"](0,0)]:0,
       List["map"](function(param){return Types["Variance"][2];},sdecl[2]),
       0,
       sdecl[8],
       sdecl[7]];
    
    return Env["add_type"](1,id,decl,env);
    };
  ...
  function(temp_env,env,id,loc)
   {var path=/* Pident */[0,id];
    ...
    if(match)
     {var
       params=
        List["map"](function(param){return Ctype["newvar"](0,0);},decl[1]);
     ...
     has_row_var=
      function(sty)
       {var match=sty[1];
        ...
        switch(exit){case 333:return 0;case 332:return 1;}
        };
    
    var match=sd[6];
    
    if(match)
     {return (sd[4]=0)&&(sd[5]=0)&&has_row_var(match[1]);}
    else
     {return 0;}
    };
  ...
  function(env,loc,p,decl)
   {var match=decl[5];
    ...
    if(match)
     ...
     {throw [0,Assert_failure,[0,"typing/typedecl.ml",113,14]];}
     ...
     {switch(match$1[0])
       {case 4:var rv=Ctype["flatten_fields"](match$1[1])[2];
        case 8:
         ...
         tm[1]=/* Tvariant */[8,(newrecord[5]=1,0,newrecord)],0;
         if(Btype["static_row"](row))
          {var rv=Btype["newgenty"](0);}
         else
          {var rv=row[2];}
    ...
    switch(exit)
     {case 328:throw [0,$$Error,loc,[18,"is not an object or variant"]];}
    
    if(!Btype["is_Tvar"](rv))
     {throw [0,$$Error,loc,[18,"has no row variable"]];}
    else
     {}
    
    return rv[1]=/* Tconstr */[3,p,decl[1],[0,0]],0;
    };
  ...
  function(env,type_path,type_params,sargs,sret_type)
   {if(sret_type)
     {var sret_type$1=sret_type[1];
      ...
      var targs=List["map"](Typetexp["transl_simple_type"](env,0),sargs);
      
      var args=List["map"](function(cty){return cty[2];},targs);
      
      var tret_type=Typetexp["transl_simple_type"](env,0,sret_type$1);
     ...
     {var targs$1=List["map"](Typetexp["transl_simple_type"](env,1),sargs);
      
      var args$1=List["map"](function(cty){return cty[2];},targs$1);
      
      return /* tuple */[0,targs$1,0,args$1,0];
      }
    };
 ...
 transl_declaration=
  function(env,sdecl,id)
   {Typetexp["reset_type_variables"](0);
    ...
    var
     cstrs=
      List["map"]
       (function(param)
         {return /* tuple */[0,
                  Typetexp["transl_simple_type"](env,0,param[1]),
                  Typetexp["transl_simple_type"](env,0,param[2]),
                  param[3]];
          },
        sdecl[3]);
    ...
    if(typeof match=="number")
     {switch(match){case 0:var match$1=[0,0,0];case 1:var match$1=[0,1,1];}}
    else
     {switch(match[0])
       {case 0:
         var scstrs=match[1];
           ...
           List["map"]
            (function(param)
              {var name=param[1];
               ...
               var cty=Typetexp["transl_simple_type"](env,1,arg);
    ...
    if(is_fixed_type(sdecl))
     {try
       ...
       {if(exn=Not_found)
         {throw [0,Assert_failure,[0,"typing/typedecl.ml",301,26]];}
        else
         {throw exn;}
        }
 ...
 generalize_decl=
  function(decl)
   {List["iter"](Ctype["generalize"],decl[1]);
    ...
    if(match$1){return Ctype["generalize"](match$1[1]);}else{return 0;}
    };
       ...
       {switch(match[0])
         {case 3:
           ...
           try
            ...
            {if(exn[1]=Ctype["Unify"])
              {throw [0,Assert_failure,[0,"typing/typedecl.ml",360,28]];}
             else
              {if(exn=Not_found)
                {throw [0,
                        $$Error,
          ...
          case 10:
           var match$1=Ctype["instance_poly"](0,0,match[2],match[1]);
          ...
          find_pl=
           function(param$1)
            {var exit$1;
             ...
             switch(exit$1)
              {case 270:
                throw [0,Assert_failure,[0,"typing/typedecl.ml",409,59]];
               }
             };
          ...
          get_loc=
           function(name,param$1)
            {if(param$1)
              ...
              {throw [0,Assert_failure,[0,"typing/typedecl.ml",413,16]];}
             };
          ...
          find_pl$1=
           function(param$1)
            {var exit$1;
             ...
             switch(exit$1)
              {case 267:
                throw [0,Assert_failure,[0,"typing/typedecl.ml",382,58]];
               }
             };
          ...
          (function(param$1)
            {var ret_type=param$1[3];
             ...
             try
              ...
              {if(exn=Not_found)
                {throw [0,Assert_failure,[0,"typing/typedecl.ml",395,30]];}
               else
                {throw exn;}
               }
    ...
    if(match$1)
     {var match$2=sdecl[6];
      ...
      if(match$2)
       ...
       {throw [0,Assert_failure,[0,"typing/typedecl.ml",428,63]];}
     ...
     {case 257:
       ...
       if(match$1)
        {var ty=match$1[1];
              ...
              try
               {var decl$prime=Env["find_type"](path,env);
                ...
                if(List["length"](args)!=List["length"](decl[1]))
                 ...
                 {if(!Ctype["equal"](env,0,args,decl[1]))
                   {var err=[0,3,0];}
                  else
                   {var
                     err=
         ...
         switch(exit$1)
          {case 255:throw [0,$$Error,loc,/* Definition_mismatch */[4,ty,0]];}
         }
       else
        {"unknown block:(exit 256)";}
 ...
 check_well_founded=
  function(env,loc,path,to_check,ty)
   {var visited=[0,Btype["TypeMap"][1]];
    ...
    var
     check=
      function(ty0,exp_nodes,ty$1)
       {var ty$2=Btype["repr"](ty$1);
        
        if(Btype["TypeSet"][3](ty$2,exp_nodes))
         {var match=ty0[1];
          ...
          var $js$1;
          switch(exit){case 247:$js$1=0;}
          if($js$1)
           {throw [0,
                   $$Error,
                   loc,
                   /* Recursive_abbrev */[2,Path["name"](0,path)]];
            }
          else
           {throw [0,
                   $$Error,
                   loc,
                   /* Cycle_in_def */[3,Path["name"](0,path),ty0]];
            }
          }
        else
         {}
        ...
        try
         {var prev=Btype["TypeMap"][22](ty$2,visited[1]);
          
          if(Btype["TypeSet"][12](exp_nodes,prev))
           {var match$1=/* tuple */[0,1,exp_nodes];}
          else
           {var match$1=/* tuple */[0,0,Btype["TypeSet"][7](exp_nodes,prev)];}
          }
        catch(exn)
         {if(exn=Not_found)
           {var match$1=/* tuple */[0,0,exp_nodes];}
          else
           {throw exn;}
          }
        ...
        if(match$1[1])
         ...
         {try
           {visited[1]=Btype["TypeMap"][4](ty$2,exp_nodes$1,visited[1]),0;
            var match$2=ty$2[1];
             ...
             {switch(match$2[0])
               {case 3:
                 if(!Btype["TypeSet"][2](exp_nodes$1)||to_check(match$2[1]))
                  {var ty$prime=Ctype["try_expand_once_opt"](env,ty$2);
                   ...
                   return check
                           (ty0$1,Btype["TypeSet"][4](ty$2,exp_nodes$1),ty$prime);
                   }
                 else
                  {exit$1=242;}
           ...
           {if(exn$1=Ctype["Cannot_expand"])
             {var match$3=ty$2[1];
              ...
              var $js$3;
              switch(exit$2){case 236:$js$3=0;case 235:$js$3=1;}
              if
               (Clflags["recursive_types"][1]&&
                Ctype["is_contractive"](env,ty$2)||
                $js$3)
               {var nodes=Btype["TypeSet"][1];}
              else
               {var nodes=exp_nodes$1;}
              
              return Btype["iter_type_expr"](check(ty0,nodes),ty$2);
              }
            else
     ...
     {var visited=[0,0];
             ...
             {switch(match[0])
               {case 3:
                 ...
                 if(Path["same"](path,path$prime))
                  {if(!Ctype["equal"](env,0,args,args$prime))
                    {throw [0,
                            $$Error,
                            loc,
                            /* Parameters_differ */[8,
                  ...
                  {if(to_check(path$prime)&&!List["mem"](path$prime,prev_exp))
                    {try
                      {var match$1=Env["find_type_expansion"](path$prime,env);
                       ...
                       var
                        match$2=
                         Ctype["instance_parameterized_type"](0,params0,match$1[2]);
                ...
                case 10:
                 var
                  match$3=
                   Ctype["instance_poly"]([0,1],0,match[2],match[1]);
      ...
      return Misc["may"]
              (function(body)
                {var
                  match=
                   Ctype["instance_parameterized_type"]([0,1],decl[1],body);
 ...
 get_variance=
  function(ty,visited)
   {try
     ...
     {if(exn=Not_found){return Types["Variance"][1];}else{throw exn;}}
    };
  ...
  function(env,visited,vari,ty)
   {var
     compute_variance_rec=
      function(vari$1,ty$1)
       {var ty$2=Ctype["repr"](ty$1);
        
        var vari$prime=get_variance(ty$2,visited);
        
        if(Types["Variance"][7](vari$1,vari$prime))
         {return 0;}
        else
         {var vari$2=Types["Variance"][5](vari$1,vari$prime);
          
          visited[1]=Btype["TypeMap"][4](ty$2,vari$2,visited[1]),0;
          var compute_same=compute_variance_rec(vari$2);
          ...
          if(typeof match=="number")
           ...
           {switch(match[0])
             {case 1:
               var v=Types["Variance"][10](vari$2);
               
               if(Types["Variance"][9](0,v)||Types["Variance"][9](1,v))
                {var v1=Types["Variance"][8](2,1,v);}
               else
                {var v1=v;}
               ...
               if(tl=0)
                ...
                {try
                  {var decl=Env["find_type"](match[1],env);
                   ...
                   var
                    cvari=
                     function(f){return Types["Variance"][9](f,vari$2);};
                   
                   return List["iter2"]
                           (function(ty$3,v$1)
                             {var cv=function(f){return Types["Variance"][9](f,v$1);};
                              
                              var strict=cvari(6)&&cv(3)||(cvari(4)||cvari(5))&&cv(6);
                              
                              if(strict)
                               {return compute_variance_rec(Types["Variance"][2],ty$3);}
                              else
                               {var p1=Types["Variance"][6](v$1,vari$2);
                                
                                var
                                 n1=
                                  Types["Variance"][6](v$1,Types["Variance"][10](vari$2));
                                ...
                                var
                                 weak=
                                  cvari(2)&&(cv(0)||cv(1))||(cvari(0)||cvari(1))&&cv(2);
                                
                                var v2=Types["Variance"][8](2,weak,v1$1);
                                
                                return compute_variance_rec(v2,ty$3);
                                }
                              },
                            tl,
                            decl[6]);
                      ...
                      {case 0:
                       ...
                       case 1:
                        var
                         upper=
                          List["fold_left"]
                           (function(s,f){return Types["Variance"][8](f,1,s);},
                            Types["Variance"][1],
                            [0,0,[0,1,[0,2,0]]]);
                        
                        var v$1=Types["Variance"][6](vari$2,upper);
              ...
              case 11:
               if
                (Types["Variance"][9](4,vari$2)||
                 Types["Variance"][9](5,vari$2))
   ...
   {var loc=param[2];
    ...
    if(check)
     {var pos=[0,0];
      ...
      var fvl=Ctype["free_variables"](0,args);
              ...
              var
               v2=
                Btype["TypeMap"][11]
                 (function(t,vt,v)
                   {if
                     (Ctype["equal"](env,0,/* :: */[0,ty$1,0],/* :: */[0,t,0]))
            ...
            (function(ty,param$1)
              {var v=get_variance(ty,tvl);
               ...
               if(!concr)
                ...
                {if(Types["Variance"][9](4,v$1)&&Types["Variance"][9](5,v$1))
...
var add_false=List["map"](function(ty){return /* tuple */[0,0,ty];});
      ...
      if(typeof match$1=="number")
       ...
       {switch(match$1[0])
         {case 3:
           ...
           var fvl=List["map"](Ctype["free_variables"](0),tyl);
              ...
              (function(param$1,ty,param$2)
                {var fv2=param$1[2];
                 ...
                 if(fv2)
                  ...
                  {throw [0,Assert_failure,[0,"typing/typedecl.ml",798,37]];}
                 },
               /* tuple */[0,0,fvl],
               tyl,
               rloc[1]);
           ...
           return compute_variance_type
                   (env,
                    check,
                    rloc,
                    (newrecord[1]=tyl,0,newrecord[4]=0,0,newrecord),
                    add_false(tl));
           
          default:exit=156;}}
      
      switch(exit)
       {case 156:throw [0,Assert_failure,[0,"typing/typedecl.ml",809,13]];}
      }
    else
     {var newrecord$1="unknown primitive:duprecord regular 9";
      
      return compute_variance_type
              (env,check,rloc,(newrecord$1[4]=0,0,newrecord$1),add_false(tl));
      }
    };
...
var
 compute_variance_decl=
  function(env,check,decl,rloc)
   {if(((decl[3]=0)||(decl[3]=1))&&(decl[5]=0))
     {return List["map"]
              (function(param)
                {return make(!param[2],!param[1],decl[3]!=0||param[3]);},
               rloc[1]);
      }
    else
     {var match=decl[5];
           ...
           return compute_variance_type
                   (env,
                    ...
                    Pervasives["@"]
                     (mn,
                      List["map"]
                       (function(param){return /* tuple */[0,param[2]=1,param[3]];},
                        match$1[1])));
           
          case 1:
           var tll=match$1[1];
           
           if(List["for_all"](function(c){return c[3]=0;},tll))
            {return compute_variance_type
                     (env,
                      check,
                      rloc,
            ...
            {var
             ...
             if(match$2)
              {var
               ...
               return List["map"]
                       (function(v)
                         {if(Types["Variance"][9](4,v)&&Types["Variance"][9](5,v))
              ...
              {throw [0,Assert_failure,[0,"typing/typedecl.ml",848,15]];}
             }
  ...
  function(env,decls,required,variances)
   {var
      ...
      List["map2"]
       (function(param,variance)
         {var newrecord="unknown primitive:duprecord regular 9";
          ...
          return /* tuple */[0,param[1],(newrecord[6]=variance,0,newrecord)];
          },
        decls,
        variances);
     ...
     new_env=
      List["fold_right"]
       (function(param,env$1)
         {return Env["add_type"](1,param[1],param[2],env$1);},
        new_decls,
        env);
    ...
    var
     new_variances=
      List["map2"]
       (function(param){return compute_variance_decl(new_env,0,param[2]);},
        new_decls,
        required);
    ...
    if("unknown primitive:caml_notequal")
     ...
     {List["iter2"]
       (function(param,req){if(!is_sharp(param[1])){return 0;}else{return 0;}},
        new_decls,
        required);
    ...
    return List["map2"]
            (function(param,param$1)
              {var decl=param[2];
               ...
               return /* tuple */[0,
                       decl,
                       (newrecord[6]=variance,0,newrecord),
                       (newrecord$1[5]=variance,0,newrecord$1),
                       (newrecord$2[4]=variance,0,newrecord$2)];
               },
             match$1[1],
             cldecls);
    };
...
var
 check_duplicates=
  function(sdecl_list)
   {var labels=Hashtbl["create"](0,7);
    
    var constrs=Hashtbl["create"](0,7);
           ...
           {if(is_fixed_type(sdecl))
             {var ty=Ctype["repr"](match$1[1]);
              ...
              if(Ctype["deep_occur"](ty,ty$prime))
               {var td=/* Tconstr */[3,/* Pident */[0,id],decl[1],[0,0]];
                
                Btype["link_type"](ty,Btype["newty2"](ty[2],td));
                var newrecord="unknown primitive:duprecord regular 9";
                
                newrecord[5]=/* Some */[0,ty$prime],0;
                return newrecord;
                }
              else
               {return decl;}
 ...
 transl_type_decl=
  function(env,rec_flag,sdecl_list)
   {var fixed_types=List["filter"](is_fixed_type,sdecl_list);
    ...
    var warn_unused=Warnings["is_active"]([18,""]);
     ...
     id_slots=
      function(id)
       {var exit;
        ...
        switch(exit){case 108:return /* tuple */[0,id,0];}
        };
    
    var
     transl_declaration$1=
      function(name_sdecl,param)
       {current_slot[1]=param[2],0;
    ...
    switch(match)
     {case 0:
      ...
      case 1:
       ...
       if((cdescr[11]=0)||(priv=1)){var usage=0;}else{var usage=2;}
       
       Env["mark_constructor"](usage,env,Longident["last"](lid[1]),cdescr);
       var match$3=Ctype["instance_constructor"](0,cdescr);
       ...
       if(cdescr[10])
        ...
        {var
          match$4=
           /* tuple */[0,Ctype["newconstr"](type_path,typext_params),0];
         }
       ...
       if(!cdescr[10])
        {var
          vars=
           Ctype["free_variables"](0,Btype["newgenty"](/* Ttuple */[2,args]));
       ...
       switch(exit)
        {case 78:throw [0,Assert_failure,[0,"typing/typedecl.ml",1162,17]];}
       ...
       var
        cstr_types=
         /* :: */[0,
          Btype["newgenty"]
           (/* Tconstr */[3,cstr_type_path,cstr_type_params,[0,0]]),
          cstr_type_params];
       
       var
        ext_types=
         /* :: */[0,
          Btype["newgenty"](/* Tconstr */[3,type_path,type_params,[0,0]]),
          type_params];
       
       if(!Ctype["equal"](env,1,cstr_types,ext_types))
        {throw [0,
                $$Error,
                lid[2],
       ...
       switch(exit$2)
        {case 72:throw [0,Assert_failure,[0,"typing/typedecl.ml",1187,17]];}
   ...
   {Typetexp["reset_type_variables"](0);
         ...
         {try
           {var
             match$2=
              List["find"]
               (function(param)
                 {switch(param[2]){case 0:return 1;case 1:return 0;}},
                styext[3]);
      ...
      List["map"]
       (function(v)
         {var match$3=Types["Variance"][11](v);
          ...
          return /* tuple */[0,!match$3[2],!match$3[1],0];
          },
        type_decl[6]);
    ...
    List["iter"]
     (function(ext)
      ...
      constructors);
    List["iter"](function(ext){return 0;},constructors);
    var
     newenv=
      List["fold_left"]
       (function(env$1,ext)
         {return Env["add_extension"](1,ext[1],ext[3],env$1);},
        env,
        constructors);
...
var
 transl_exception=
  function(env,sext)
   {Typetexp["reset_type_variables"](0);
    Ctype["begin_def"](0);
    var ext=transl_extension_constructor(env,0,Predef["path_exn"],0,0,1,sext);
    ...
    var newenv=Env["add_extension"](1,ext[1],ext[3],env);
   ...
   {var cty=Typetexp["transl_type_scheme"](env,valdecl[2]);
    ...
    if(decl)
     {var arity=Ctype["arity"](ty);
      ...
      if((arity=0)&&prim[1][0]!=37){throw [0,$$Error,valdecl[2][2],2];}else{}
     ...
     {var v=/* record */[0,ty,0,loc,valdecl[4]];}
  ...
  function(env,id,row_path,orig_decl,sdecl)
   {Env["mark_type_used"](env,Ident["name"](id),orig_decl);
      ...
      List["map"]
       (function(param)
         {var loc=param[3];
          ...
          try
           {var cty=Typetexp["transl_simple_type"](env,0,param[1]);
            
            var cty$prime=Typetexp["transl_simple_type"](env,0,param[2]);
    ...
    if(sdecl[5]=0)
     ...
     {if(arity_ok&&orig_decl$1[3]!=0)
       {var priv=orig_decl$1[4];}
      else
       {var priv=sdecl[5];}
      }
    
    if(arity_ok&&orig_decl$1[3]!=0&&(sdecl[5]=0))
     {Location["prerr_warning"](sdecl[8],[0,"spurious use of private"])}
    else
     {}
    ...
    var
     decl=
      /* record */[0,
       params,
       List["length"](params),
       arity_ok&&man!=0?orig_decl$1[3]:0,
       priv,
       man,
       0,
       0,
     ...
     make_params$1=
      function(n)
       {if(n<=0)
         ...
         {return /* :: */[0,Ctype["newvar"](0,0),make_params$1(n-1)];}
        };
  ...
  function(env,loc,recmod_ids,path,decl)
   {var
     to_check=
      function(path$1)
       {return List["exists"]
                (function(id){return Path["isfree"](id,path$1);},recmod_ids);
        };
  ...
  function(ppf,tv,tl,typ,kwd,lab)
   {try
     {var
       ti=
        List["find"]
         (function(ti$1){return Ctype["deep_occur"](tv,typ(ti$1));},tl);
      
      var ty0=Btype["newgenty"](/* Tobject */[4,tv,[0,0]]);
                     ...
                     [17,
                      ...
                      [2,
                       ...
                       [15,
                        [17,
                         [0,"@;<1 -2>",1,-2],
                         [11,"the variable ",[15,[11," is unbound",[17,0,0]]]]]]]]]]]]],
                   ...
                   (ppf,
                    ...
                    function(param)
                     {var match$2=Btype["row_field_repr"](param[2]);
                      ...
                      switch(exit$1){case 12:return Btype["newgenty"]([2,0]);}
                      },
                    "case",
                    function(param)
                     {return Pervasives["^"]
       ...
       {case 0:
                  ...
                  [0,
                   [18,
                    ...
                    [11,
                     ...
                     [17,
                      [0,"@ ",1,0],
                      [11,"-- maximum is ",[4,3,0,0,[12,32,[2,0,[17,0,0]]]]]]]],
        ...
        case 2:
         return Format["fprintf"]
                 (ppf,
                  [0,
                   [11,"External identifiers must be functions",0],
                  ...
                  [0,
                   [18,
                    ...
                    [11,
                     ...
                     [17,
                      [0,"@ ",1,0],
                      [11,"for native-code compilation",[17,0,0]]]]],
                 ...
                 (ppf,
                  [0,
                   [18,
                    ...
                    [2,
                     0,
                     [17,[0,"@ ",1,0],[2,0,[17,[0,"@ ",1,0],[2,0,[17,0,0]]]]]]],
                   "@[%s@ %s@ %s@]"],
     ...
     {switch(param[0])
       {case 0:
         return Format["fprintf"]
                 (ppf,
                  [0,
                   [11,"Two constructors are named ",[2,0,0]],
        ...
        case 2:
         return Format["fprintf"]
                 (ppf,
                  [0,
                   [11,"The type abbreviation ",[2,0,[11," is cyclic",0]]],
                  ...
                  [0,
                   [18,
                    ...
                    [11,
                     ...
                     [2,
                      0,
                      [11," contains a cycle:",[17,[0,"@ ",1,0],[15,[17,0,0]]]]]]],
                   ...
                   [18,
                    ...
                    [18,
                     ...
                     [2,
                      ...
                      [17,
                       [0,"@ ",1,0],
                       [2,0,[17,[0,"@;<1 2>",1,2],[15,[17,0,[15,[17,0,0]]]]]]]]]],
                   "@[<v>@[<hov>%s@ %s@;<1 2>%a@]%a@]"],
        ...
        case 6:
         Format["fprintf"]
          (ppf,
           [0,
            [11,"The type constraints are not consistent.",[17,4,0]],
                 ...
                 (ppf,
                  ...
                  function(ppf$1)
                   {return Format["fprintf"]
                            (ppf$1,
                             [0,
                              [11,"This type constructor expands to type",0],
                  ...
                  function(ppf$1)
                   {return Format["fprintf"]
                            (ppf$1,
                             [0,
                              [11,"but is used here with type",0],
                      ...
                      [11,
                       ...
                       [17,
                        ...
                        [15,
                         [17,
                          [0,"@ ",1,0],
                          [11,"should be",[17,[0,"@ ",1,0],[15,[17,0,0]]]]]]]]]]],
        ...
        case 9:
         ...
         Format["fprintf"]
          (ppf,
           [0,
            [11,"A type variable is unbound in this type declaration",0],
                 ...
                 (ppf,
                  [0,
                   [18,
                    ...
                    [2,
                     0,
                     [17,[0,"@ ",1,0],[15,[17,[0,"@ ",1,0],[2,0,[17,0,0]]]]]]],
                   "@[%s@ %a@ %s@]"],
                  "Type",
                  Printtyp["path"],
                  param[1],
                   ...
                   [18,
                    ...
                    [18,
                     ...
                     [2,
                      ...
                      [17,
                       [0,"@ ",1,0],
                       [2,0,[17,[0,"@;<1 2>",1,2],[2,0,[17,0,[15,[17,0,0]]]]]]]]]],
                   "@[<v>@[<hov>%s@ %s@;<1 2>%s@]%a@]"],
                  "This extension",
                 ...
                 (ppf,
                  ...
                  function(ppf$1)
                   {return Format["fprintf"]
                            (ppf$1,
                             [0,
                              [11,"but was expected to be of type",0],
         ...
         if(n=-1)
          {Format["fprintf"]
            (ppf,
             [0,
              [18,
               [1,[0,0,""]],
               [2,0,[17,[0,"@ ",1,0],[2,0,[17,[0,"@ ",1,0],[11,"It",0]]]]]],
              "@[%s@ %s@ It"],
          ...
          {if(n=-2)
            {Format["fprintf"]
              (ppf,
               [0,
                [18,[1,[0,0,""]],[2,0,[17,[0,"@ ",1,0],[2,0,[17,0,0]]]]],
                "@[%s@ %s@]"],
                   ...
                   [2,
                    ...
                    [17,
                     ...
                     [2,
                      ...
                      [17,
                       [0,"@ ",1,0],
                       [11,"The ",[4,0,0,0,[2,0,[11," type parameter",0]]]]]]]]],
                    ...
                    [0,
                     [11,
                      ...
                      [2,
                       ...
                       [12,
                        44,
                        [17,[0,"@ ",1,0],[11,"but it is ",[2,0,[12,46,[17,0,0]]]]]]]],
                 ...
                 (ppf,
                  [0,
                   [11,
                    ...
                    [15,[17,[0,"@ ",1,0],[11,"is unavailable",0]]]],
        ...
        case 18:
         return Format["fprintf"]
                 (ppf,
                  [0,[11,"This fixed type ",[2,0,0]],"This fixed type %s"],
                  param[1]);
        ...
        case 19:
         Format["fprintf"]
          (ppf,
           [0,
            [11,"A type variable is unbound in this extension constructor",0],
