      ...
      case 2:
       ...
       if
        (Clflags["applicative_functors"][1]&&
         CamlPrimitive["caml_string_notequal"](Ident["name"](param),"*"))
       ...
       {case 1:
         ...
         if(match)
          {if(match$1!==0)
            ...
            {if(typeof match$2==="number"){exit=56;}else{var newdecl=decl;}}
           }
         else
          {exit=56;}
        ...
        case 3:
         ...
         return /* :: */[0,
                 ...
                 strengthen_sig
                  (Env["add_module_declaration"](/* None */0,id$1,md,env),
                   sg[2],
                   p)];
 ...
 nondep_supertype=
  function(env,mid,mty)
   {var
       ...
       {switch(mty[0])
         {case 0:
           ...
           if(Path["isfree"](mid,p))
            {return nondep_mty(env,va,Env["find_modtype_expansion"](p,env));}
           else
            {return mty;}
           
          case 1:return /* Mty_signature */[1,nondep_sig(env,va,mty[1])];
          case 2:
           var arg=mty[2];
           ...
           switch(va)
            {case 0:var var_inv=/* Contra */1;
             case 1:var var_inv=/* Co */0;
             case 2:var var_inv=/* Strict */2;
             }
          ...
          case 3:
           ...
           if(Path["isfree"](mid,p$1))
            {return nondep_mty(env,va,Env["find_module"](p$1,env)[1]);}
           else
            {return mty;}
    ...
    var
     nondep_sig=
      function(env,va,param)
       {if(param)
         {var item=param[1];
          
          var rem$prime=nondep_sig(env,va,param[2]);
           ...
           {case 0:
            ...
            case 1:
             ...
             return /* :: */[0,
                     /* Sig_type */[1,
                      id,
                      Ctype["nondep_type_decl"](env,mid,id,va===/* Co */0,item[2]),
                      item[3]],
                     rem$prime];
            ...
            case 2:
             return /* :: */[0,
                     /* Sig_typext */[2,
                      item[1],
                      Ctype["nondep_extension_constructor"](env,mid,item[2]),
                      item[3]],
                     rem$prime];
            ...
            case 3:
             ...
             return /* :: */[0,
                     /* Sig_module */[3,
                      item[1],
                      /* record */[0,nondep_mty(env,va,md[1]),md[2],md[3]],
                      item[3]],
                     rem$prime];
            ...
            case 4:
             ...
             try
              {return /* :: */[0,
                       /* Sig_modtype */[4,id$1,nondep_modtype_decl(env,item[2])],
                       rem$prime];
               }
             catch(exn)
              {if(exn===CamlPrimitive["caml_global_data"]["Not_found"])
                {if(va!==0)
                  ...
                  {return /* :: */[0,
                           /* Sig_modtype */[4,
                            id$1,
                            /* record */[0,/* None */0,/* [] */0,Location["none"]]],
                           rem$prime];
                   }
                 }
               else
            ...
            case 5:
             return /* :: */[0,
                     /* Sig_class */[5,
                      item[1],
                      Ctype["nondep_class_declaration"](env,mid,item[2]),
                      item[3]],
                     rem$prime];
            ...
            case 6:
             return /* :: */[0,
                     /* Sig_class_type */[6,
                      item[1],
                      Ctype["nondep_cltype_declaration"](env,mid,item[2]),
                      item[3]],
                     rem$prime];
    ...
    var
     nondep_modtype_decl=
      function(env,mtd)
       {return /* record */[0,
                Misc["may_map"](nondep_mty(env,/* Strict */2),mtd[1]),
                mtd[2],
                mtd[3]];
        };
       ...
       {var orig_decl=Env["find_type"](p,env);
        ...
        if(orig_decl[2]!==decl[2])
         ...
         {var newrecord=/* unknown */"duprecord regular 9";
          ...
          newrecord[5]=
          /* Some */[0,
           Btype["newgenty"](/* Tconstr */[3,p,decl[1],[0,/* Mnil */0]])];
          return newrecord;
          }
        }
      catch(exn)
 ...
 type_paths=
  function(env,p,mty)
   {var match$1=scrape(env,mty);
    ...
    switch(match$1[0])
     {case 1:return type_paths_sig(env,p,0,match$1[1]);
      default:return /* [] */0;}
    };
        ...
        case 3:
         ...
         return Pervasives["@"]
                 (type_paths(env,/* Pdot */[1,p,Ident["name"](id),pos],md[1]),
                  type_paths_sig
                   (Env["add_module_declaration"](/* None */0,id,md,env),
                    p,
                    pos+1,
                    sg[2]));
 ...
 no_code_needed=
  function(env,mty)
   {var match$1=scrape(env,mty);
    ...
    switch(exit){case 35:return /* false */0;}
    };
     ...
     {var match$1=sg[1];
      ...
      switch(match$1[0])
       {case 0:
         ...
         switch(exit$1){case 36:return /* false */0;}
        ...
        case 3:
         ...
         return no_code_needed(env,md[1])&&
                no_code_needed_sig
                 (Env["add_module_declaration"](/* None */0,match$1[1],md,env),
                  sg[2]);
         
        case 5:exit=38;
        default:return no_code_needed_sig(env,sg[2]);}
      
      switch(exit){case 38:return /* false */0;}
      }
    else
     {return /* true */1;}
    };
...
var
 contains_type$1=
  function(env,mty)
   {try
     {contains_type(env,mty);return /* false */0;}
    catch(exn)
 ...
 compare=
  function(p1,p2)
   {if(Path["same"](p1,p2))
     ...
     {return CamlPrimitive["caml_compare"](p1,p2);}
    };
 ...
 get_prefixes=
  function(param)
   {var exit;
    ...
    switch(param[0]){case 0:return PathSet[1];case 1:exit=24;case 2:exit=24;}
 ...
 collect_arg_paths=
  function(mty)
   {var paths=[0,PathSet[1]];
    ...
    newrecord[2]=it_signature_item;
    newrecord[15]=it_path;
    var it=newrecord;
    ...
    switch(mty[0])
     {case 0:exit=4;
      ...
      case 3:
       ...
       if(CamlPrimitive["caml_equal"](mty$prime,mty))
        {return mty;}
       else
       ...
       {case 3:
         ...
         return /* :: */[0,
                 /* Sig_module */[3,
                  ...
                  it[3]],
                 remove_aliases_sig
                  (Env["add_module"](/* None */0,id,mty$1,env),excl,sg[2])];
