...
var Not_simple=CamlPrimitive["caml_set_oo_id"]([248,"Switch.Not_simple",0]);
         ...
         add=
          function(mustshare,act)
           {var i=st[2];
            ...
            st[3]=/* :: */[0,/* tuple */[0,mustshare,act],st[3]];
            st[2]=i+1;
            return i;
            };
             ...
             {var key=match[1];
              ...
              try
               {var match$1=AMap[22](key,st[1]);
                ...
                if(!match$1[1])
                 {st[1]=AMap[4](key,/* tuple */[0,/* true */1,i],st[1])}
                else
                 {}
               ...
               {if(exn===CamlPrimitive["caml_global_data"]["Not_found"])
                 {var i$1=add(mustshare,act);
                  ...
                  st[1]=AMap[4](key,/* tuple */[0,mustshare,i$1],st[1]);
                  return i$1;
                  }
                else
                 {throw exn;}
             ...
             (function(param$2,param$3)
               {if(param$3[1])
                 {var i=param$3[2];
                  ...
                  switch(match[0])
                   {case 0:return /* () */0;
                    case 1:return acts[i+1]=/* Shared */[0,match[1]],0;
                    }
                  }
                else
                 {return 0;}
 ...
 Make=
  function(Arg)
   {var cut=[0,8];
      ...
      function(chan,i)
       {if(i===Pervasives["min_int"])
         {return Printf["fprintf"]
                  (chan,
                   [/* Format */0,
                    [/* String_literal */11,"-oo",/* End_of_format */0],
                    "-oo"]);
          }
        else
    ...
    var get_act=function(cases,i){var match=cases[i+1];return match[3];};
    
    var get_low=function(cases,i){var match=cases[i+1];return match[1];};
     ...
     count_tests=
      function(s)
       {var
         r=
          $$Array["init"]
           (/* -1 for tag */s[2]["length"]-1,
            function(param){return /* record */[0,0,0];});
        
        var c=s[1];
        
        var imax=/* -1 for tag */c["length"]-1-1;
        ...
        for(var i=0;i<=imax;i++)
         {var match=c[i+1];
          ...
          x[1]=x[1]+1;
          if(match[1]<match[2]&&i!==0&&i!==imax){x[2]=x[2]+1}else{}
          }
     ...
     less_tests=
      function(c1,c2)
       {if(c1[1]<c2[1])
         ...
         {if(c1[1]===c2[1])
           {if(c1[2]<c2[2]){return /* true */1;}else{return /* false */0;}}
          else
           {return /* false */0;}
          }
        };
    ...
    var
     add_test=
      function(t1,t2){t1[1]=t1[1]+t2[1];return t1[2]=t1[2]+t2[2],0;};
         ...
         {switch(param)
           {case 0:
             return Printf["fprintf"]
                     (chan,
                      [/* Format */0,
                       [/* String_literal */11,"No",/* End_of_format */0],
                       "No"]);
      ...
      function(cases,i)
       {var match=cases[i+1];
        ...
        return /* tuple */[0,
                match[1],
                $$Array["sub"](cases,0,i),
                $$Array["sub"](cases,i,/* -1 for tag */cases["length"]-1-i)];
        };
    
    var
     case_append=
      function(c1,c2)
       {var len1=/* -1 for tag */c1["length"]-1;
        
        var len2=/* -1 for tag */c2["length"]-1;
        
        if(len1!==0)
         {if(len2!==0)
           {var match=c1[/* -1 for tag */c1["length"]-1-1+1];
            ...
            if(CamlPrimitive["caml_equal"](act1,act2))
             {var r=CamlPrimitive["caml_make_vect"](len1+len2-1,c1[1]);
              
              for(var i=0;i<=len1-2;i++){r[i+1]=c1[i+1]}
              
              if(len1-2>=0)
               {var match$2=r[len1-2+1];
              ...
              r[len1-1+1]=/* tuple */[0,l,h$1,act1];
              for(var i$1=1;i$1<=len2-1;i$1++){r[len1-1+i$1+1]=c2[i$1+1]}
              
              return r;
              }
            else
             {if(h1>l1)
               {var r$1=CamlPrimitive["caml_make_vect"](len1+len2,c1[1]);
                
                for(var i$2=0;i$2<=len1-2;i$2++){r$1[i$2+1]=c1[i$2+1]}
                
                r$1[len1-1+1]=/* tuple */[0,l1,l2-1,act1];
                for(var i$3=0;i$3<=len2-1;i$3++){r$1[len1+i$3+1]=c2[i$3+1]}
                
                return r$1;
                }
              else
               {if(h2>l2)
                 {var r$2=CamlPrimitive["caml_make_vect"](len1+len2,c1[1]);
                  
                  for(var i$4=0;i$4<=len1-1;i$4++){r$2[i$4+1]=c1[i$4+1]}
                  
                  r$2[len1+1]=/* tuple */[0,h1+1,h2,act2];
                  for(var i$5=1;i$5<=len2-1;i$5++){r$2[len1+i$5+1]=c2[i$5+1]}
    ...
    var
     coupe_inter=
      function(i,j,cases)
       {var lcases=/* -1 for tag */cases["length"]-1;
        
        var match=cases[i+1];
        
        var match$1=cases[j+1];
         ...
         {switch(param)
           {case 0:
             return Printf["fprintf"]
                     (chan,
                      [/* Format */0,
                       [/* Char_literal */12,69,/* End_of_format */0],
                       "E"]);
      ...
      function(cases)
       {var seen=[0,/* [] */0];
          ...
          function(act,param)
           {if(param)
             {var match=param[1];
              ...
              if(CamlPrimitive["caml_equal"](match[1],act))
               {return match[2];}
              else
               {return got_it(act,param[2]);}
              }
            else
             {seen[1]=/* :: */[0,/* tuple */[0,act,count[1]],seen[1]];
              var r=count[1];
        ...
        var
         make_one=
          function(l,h,act)
           {if(CamlPrimitive["caml_equal"](l,h))
        ...
        var match=cases[/* -1 for tag */cases["length"]-1-1+1];
        
        var l=match[1];
        
        return /* :: */[0,
                make_one(l,match[2],match[3]),
                make_rec(/* -1 for tag */cases["length"]-1-2,l)];
        };
    
    var
     same_act=
      function(t)
       {var len=/* -1 for tag */t["length"]-1;
        
        var a=get_act(t,len-1);
          ...
          function(i)
           {if(i<0)
             ...
             {var b=get_act(t,i);
              ...
              return CamlPrimitive["caml_equal"](b,a)&&do_rec(i-1);
              }
            };
     ...
     divide=
      function(top,cases)
       {var lcases=/* -1 for tag */cases["length"]-1;
        ...
        var match$1=opt_count(/* false */0,match[2]);
        
        var match$2=match$1[2];
        
        var cml=match$2[1];
        
        var match$3=opt_count(/* false */0,match[3]);
     ...
     heuristic=
      function(top,cases)
       {var lcases=/* -1 for tag */cases["length"]-1;
        ...
        var match=divide(/* false */0,cases);
        ...
        if(ok_inter[1])
         {var match$1=cases[1];
          ...
          var match$2=cases[lcases-1+1];
          
          if(CamlPrimitive["caml_equal"](match$1[3],match$2[3]))
           {var match$3=coupe_inter(1,lcases-2,cases);
            ...
            var match$4=opt_count(/* false */0,match$3[3]);
            
            var match$5=match$4[2];
            
            var cmi=match$5[1];
            
            var match$6=opt_count(/* false */0,match$3[4]);
          ...
          for(var i$1=1;i$1<=lcases-2;i$1++)
           {var match$6=coupe_inter(i$1,i$1,cases);
            ...
            if(match$6[1]===match$6[2])
             {var match$7=opt_count(/* false */0,match$6[3]);
              
              var match$8=match$7[2];
              
              var cmi=match$8[1];
              
              var match$9=opt_count(/* false */0,match$6[4]);
          ...
          for(var i$2=1;i$2<=lcases-2;i$2++)
           {for(var j=i$2;j<=lcases-2;j++)
             {var match$12=coupe_inter(i$2,j,cases);
              ...
              var match$13=opt_count(/* false */0,match$12[3]);
              
              var match$14=match$13[2];
              
              var cmi$1=match$14[1];
              
              var match$15=opt_count(/* false */0,match$12[4]);
      ...
      function(ctx,s)
       {var actions=s[2];
        ...
        if(lcases>0)
         ...
         {throw [0,
                 CamlPrimitive["caml_global_data"]["Assert_failure"],
                 [0,"bytecomp/switch.ml",611,6]];
          }
        
        if(lcases===1)
         {return actions[get_act(cases,0)+1](ctx);}
        else
         {var match=opt_count(/* false */0,cases);
          
          var w=match[1];
          
          if(typeof w==="number")
           {switch(w){case 0:return actions[get_act(cases,0)+1](ctx);}}
          else
           {switch(w[0])
             {case 0:
               ...
               var match$2=opt_count(/* false */0,inside);
               
               var cinside=match$2[2][1];
               
               var match$3=opt_count(/* false */0,outside);
                ...
                {if(less_tests(coutside,cinside))
                  {return make_if_in
                           (ctx,
                            ...
                            high-low,
                            function(ctx)
                             {return c_test(ctx,/* record */[0,inside,s[2]]);},
                            function(ctx)
                             {return c_test(ctx,/* record */[0,outside,s[2]]);});
                   }
                 else
                  {return make_if_out
                           (ctx,
              ...
              case 1:
               ...
               var match$5=opt_count(/* false */0,left);
               
               var match$6=opt_count(/* false */0,right);
     ...
     particular_case=
      function(cases,i,j)
       {var match=cases[i+1];
        ...
        var match$1=cases[i+1+1];
        
        var l2=match$1[1];
        
        var match$2=cases[i+2+1];
        ...
        return j-
               ...
               l3===
               match$2[2]&&
               CamlPrimitive["caml_notequal"](match[3],match$2[3]);
        };
     ...
     approx_count=
      function(cases,i,j,n_actions)
       {var l=j-i+1;
        ...
        if(l<cut[1])
         {var match=opt_count(/* false */0,$$Array["sub"](cases,i,l));
      ...
      function(param,i,j)
       {if(i===j)
         ...
         {var cases=param[1];
          ...
          var
           ntests=
            approx_count(cases,i,j,/* -1 for tag */param[2]["length"]-1);
    ...
    var
     comp_clusters=
      function(s)
       {var len=/* -1 for tag */s[1]["length"]-1;
        
        var
         min_clusters=
          CamlPrimitive["caml_make_vect"](len,Pervasives["max_int"]);
        
        var k=CamlPrimitive["caml_make_vect"](len,0);
        
        var
         get_min=
          function(i){if(i<0){return 0;}else{return min_clusters[i+1];}};
        
        for(var i=0;i<=len-1;i++)
         {for(var j=0;j<=i;j++)
           {if(dense(s,j,i)&&get_min(j-1)+1<min_clusters[i+1])
             {k[i+1]=j,min_clusters[i+1]=get_min(j-1)+1}
            else
             {}
            }
          }
        
        return /* tuple */[0,min_clusters[len-1+1],k];
        };
     ...
     make_switch=
      function(param,i,j)
       {var actions=param[2];
        ...
        var tbl=CamlPrimitive["caml_make_vect"](match$1[2]-ll+1,0);
        
        var t$1=Hashtbl["create"](/* None */0,17);
        ...
        for(var k=i;k<=j;k++)
         {var match$2=cases[k+1];
          
          var index$1=get_index(match$2[3]);
          
          for(var kk=match$2[1]-ll;kk<=match$2[2]-ll;kk++){tbl[kk+1]=index$1}
          }
        
        var acts=CamlPrimitive["caml_make_vect"](index[1],actions[1]);
        
        Hashtbl["iter"]
         (function(act,i){return acts[i+1]=actions[act+1],0;},t$1);
        return function(ctx)
     ...
     make_clusters=
      function(s,n_clusters,k)
       {var actions=s[2];
        ...
        var len=/* -1 for tag */cases["length"]-1;
        
        var
         r=
          CamlPrimitive["caml_make_vect"](n_clusters,[/* tuple */0,0,0,0]);
        
        var t$1=Hashtbl["create"](/* None */0,17);
        
        var index=[0,0];
        
        var bidon=[0,/* -1 for tag */actions["length"]-1];
             ...
             {if(exn===CamlPrimitive["caml_global_data"]["Not_found"])
               {var i=index[1];
                ...
                Hashtbl["add"]
                 (t$1,
                  act,
                  /* tuple */[0,i,function(param){return actions[act+1];}]);
                return i;
                }
              else
               {throw exn;}
           ...
           {var i=k[j+1];
            ...
            if(i===j)
             {var match=cases[i+1];
              ...
              r[ir+1]=/* tuple */[0,match[1],match[2],get_index(match[3])]}
            else
             {var match$1=cases[i+1];
              
              var match$2=cases[j+1];
          ...
          CamlPrimitive["caml_make_vect"]
           (index[1],
            function(param)
             {throw [0,
                     CamlPrimitive["caml_global_data"]["Assert_failure"],
                     [0,"bytecomp/switch.ml",823,41]];
              });
        
        Hashtbl["iter"]
         (function(param,param$1){return acts[param$1[1]+1]=param$1[2],0;},
          t$1);
     ...
     do_zyva=
      function(param,arg,cases,actions)
       {var old_ok=ok_inter[1];
        ...
        inter_limit;
        if(CamlPrimitive["caml_notequal"](ok_inter[1],old_ok))
         {Hashtbl["clear"](t)}
        else
         {}
           ...
           (function(act)
             {switch(act[0])
               {case 0:
                 ...
                 handlers[1]=function(act){return h(oh(act));};
