       ...
       struct
         ...
         let decorate_side_effect ({ st; should_return;_} : Compile_defs.cxt)
           ...
           | (_,true )|((Assign _|Declare _|NeedValue ),_) ->
               E.seq e (E.unit ())
           | (EffectCall ,false ) -> e
         let compile_primitive (st : Compile_defs.cxt)
                        ...
                        let rec compile_lambda
                          ...
                          (match lam with
                                 ...
                                 | (_,_,{ block; value = Some e }) ->
                                     let dispatch e =
                                       [S.if_
                                          ...
                                          (S.block (aux cxt e sw_consts None))
                                          ~else_:(S.block
                                                    (aux cxt (E.tag e)
                                                       sw_blocks default : 
                                                    J.block))] in
                           ...
                           | Lstaticcatch _ ->
                               ...
                               ((Gen_util.make_output [S.variable exit_id])
                                  ++
