...
var $$Error=CamlPrimitive["caml_set_oo_id"]([248,"Bytelink.Error",0]);
 ...
 add_ccobjs=
  function(origin,l)
   {if(!Clflags["no_auto_link"][1])
     {if
       (Clflags["use_runtime"][1]["length"]===
        0&&
        Clflags["use_prims"][1]["length"]===
        0)
       {if(l[2]){Clflags["custom_runtime"][1]=/* true */1}else{}
        
        lib_ccobjs[1]=Pervasives["@"](l[3],lib_ccobjs[1]);
 ...
 is_required=
  function(param)
   {var rel=param[1];
    ...
    switch(rel[0])
     {case 2:return IdentSet[3](rel[1],missing_globals[1]);
             ...
             (function(compunit,reqd)
               {if
                 (compunit[7]||
                  ...
                  List["exists"](is_required,compunit[4]))
                 {List["iter"](remove_required,compunit[4]);
                  List["iter"](add_required,compunit[4]);
  ...
  function(file)
   {if(Filename["is_relative"](file))
     {return Filename["concat"]
              (CamlPrimitive["caml_sys_getcwd"](/* () */0),file);
      }
    else
     {return file;}
    };
   ...
   {List["iter"]
     (function(param)
       {var exit;
        ...
        switch(param[0])
         {case 0:
           if(CamlPrimitive["caml_string_equal"](param[1],exec_name))
    ...
    try
     {if(standalone)
      ...
      var
       check_dlls=
        standalone&&
        CamlPrimitive["caml_string_equal"](Config["target"],Config["host"]);
      
      if(check_dlls)
       {Dll["init_compile"](Clflags["no_std_include"][1]);
        Dll["add_path"](Config["load_path"][1]);
        try
         {Dll["open_dlls"](/* For_checking */0,sharedobjs)}
        catch(exn$1)
      ...
      try
       {Marshal["to_channel"]
         (outchan,
          ...
          Clflags["bytecode_compatible_32"][1]
           ?[/* :: */0,/* Compat_32 */2,/* [] */0]
           :/* [] */0)}
      catch(exn$2)
       {if(exn$2[1]===CamlPrimitive["caml_global_data"]["Failure"])
         {throw [0,$$Error,/* Not_compatible_32 */1];}
        else
         {throw exn$2;}
        }
    ...
    while(pos<len)
     {var c1=code[pos];
      ...
      if(output_code_string_counter[1]>=6)
       {Pervasives["output_char"](outchan,10),output_code_string_counter[1]=0}
      else
       {}
      }
    return 0;
   ...
   {var outchan=Pervasives["open_out"](outfile);
    ...
    try
     {Pervasives["output_string"]
      ...
      output_data_string
       (outchan,
        CamlPrimitive["caml_output_value_to_string"]
         (Symtable["initial_global_table"](/* () */0),/* [] */0));
      Pervasives["output_string"](outchan,"\n};\n\n");
      var
       sections=
        /* :: */[0,
         ...
         /* :: */[0,
          ...
          /* :: */[0,
           /* tuple */[0,"CRCS",extract_crc_interfaces(/* () */0)],
           /* [] */0]]];
      
      Pervasives["output_string"](outchan,"static char caml_sections[] = {\n"),
      output_data_string
       (outchan,
        CamlPrimitive["caml_output_value_to_string"](sections,/* [] */0)),
      Pervasives["output_string"](outchan,"\n};\n\n"),
 ...
 link=
  function(ppf,objfiles,output_name)
   {if(Clflags["nopervasives"][1])
    ...
    Clflags["ccobjs"][1]=Pervasives["@"](Clflags["ccobjs"][1],lib_ccobjs[1]);
    Clflags["all_ccopts"][1]=
    Pervasives["@"](lib_ccopts[1],Clflags["all_ccopts"][1]);
    Clflags["dllibs"][1]=Pervasives["@"](lib_dllibs[1],Clflags["dllibs"][1]);
    if(!Clflags["custom_runtime"][1])
     {return link_bytecode(ppf,tolink,output_name,/* true */1);}
    else
     {if(!Clflags["output_c_object"][1])
       {var bytecode_name=Filename["temp_file"](/* None */0,"camlcode","");
        
        var prim_name=Filename["temp_file"](/* None */0,"camlprim",".c");
        
        try
         {link_bytecode(ppf,tolink,bytecode_name,/* false */0);
          ...
          if(!build_custom_runtime(prim_name,exec_name))
           {throw [0,$$Error,/* Custom_runtime */0];}
          else
           {}
       ...
       {var basename=Filename["chop_extension"](output_name);
        ...
        if(Clflags["output_complete_object"][1])
         {var c_file=Filename["temp_file"](/* None */0,"camlobj",".c");}
        else
        ...
        if(Clflags["output_complete_object"][1])
         {var
           obj_file=
            Filename["temp_file"](/* None */0,"camlobj",Config["ext_obj"]);
          }
        else
         {var obj_file=Pervasives["^"](basename,Config["ext_obj"]);}
        
        if(CamlPrimitive["caml_sys_file_exists"](c_file))
            ...
            if
             ...
             {temps=/* :: */[0,obj_file,temps];
              ...
              if(Filename["check_suffix"](output_name,Config["ext_obj"]))
               {var match=[/* tuple */0,/* Partial */3,""];}
              else
               {var
                 match=
                  /* tuple */[0,/* MainDll */2,Config["bytecomp_c_libraries"]];
                }
