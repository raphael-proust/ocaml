    ...
    if(typeof st=="number")
     ...
     {switch(st[0])
       {case 3:
         ...
         if(match){var st$1=match[1];exit=1078;}else{return 1;}
         
        case 5:var st$1=st[2];exit=1078;
        case 6:var st$1=st[4];exit=1078;
        case 7:var st$1=st[3];exit=1078;
        default:exit=1079;}}
    
    switch(exit)
     {case 1079:return 0;case 1078:return ends_with_if_without_else(st$1);}
    };
 ...
 need_paren=
  function(l,e)
   {var match=e[1];
    ...
    switch(exit)
     {case 1074:return l<=15&&need_paren(15,match[1]);case 1073:return 1;}
    };
     ...
     {var c=s[i];
      ...
      if(c>=32)
       {if(c>=127)
         ...
         {if(c!=92){exit=1054;}else{if(!utf){Pp[1](f,"\\")}else{exit=1054;}}}
        }
      else
       {if(c>=14)
         {exit=1055;}
         ...
         {switch(c[0])
           {case 0:
             if((i=l-1)||s[i+1]<48||s[i+1]>57){Pp[1](f,"\0")}else{exit=1055;}
            case 1:exit=1055;
            case 2:exit=1055;
            case 3:exit=1055;
            case 4:exit=1055;
          ...
          return function(f,loc)
           {var exit;
            ...
            if("unknown primitive:isint")
             {if(loc!=0){exit=1032;}else{return 0;}}
            else
             {var match$2=loc[1];
            ...
            switch(exit)
             {case 1032:return push_mapping(Pp[12](f),[0,-1,-1,-1,-1,-1,0]);}
            };
          }
        else
    ...
    switch(lam)
     {case 0:exit=224;
      ...
      case 6:
       ...
       var $js$2;
       switch(exit$1){case 222:$js$2=0;case 220:$js$2=0;case 221:$js$2=1;}
       return List["for_all"](is_pure,lam[2])&&$js$2;
       
      default:return 0;}
    
    switch(exit){case 224:return 1;}
    };
     ...
     {switch(prim)
       {case 0:
        ...
        case 32:
         ...
         switch(exit$8){case 87:return Gen_util[5](prim);}
     ...
     {switch(prim[0])
       {case 0:
        ...
        case 1:
         ...
         switch(exit$10){case 98:return Gen_util[5](prim);}
        ...
        case 6:
         ...
         switch(exit$11){case 47:return Gen_util[5](prim);}
        ...
        case 14:
         ...
         switch(exit$15){case 53:return Gen_util[5](prim);}
        ...
        case 15:
         ...
         if(2<switcher>>>0)
          ...
          {switch(switcher[0])
            {case 0:
              ...
              switch(exit$17){case 57:return Gen_util[5](prim);}
             ...
             case 2:
              ...
              switch(exit$18){case 55:return Gen_util[5](prim);}
         ...
         switch(exit$16)
          {case 139:
            ...
            switch(exit$19){case 59:return Gen_util[5](prim);}
        ...
        case 36:exit=127;
        case 37:exit=128;
        case 38:var cmp=prim[2];exit=132;
        default:exit=138;}}
    
    switch(exit)
     {case 140:return Gen_util[5](prim);
      case 141:"unknown block:(exit 132 (field 0 prim/1708))";
      case 120:
       var exit$20;
       
       if(args)
        {if(args[2]){exit$20=49;}else{return E$3[12](0,1,args[1]);}}
       else
        {exit$20=49;}
       
       switch(exit$20){case 49:return Gen_util[5](prim);}
      ...
      case 121:
       ...
       switch(exit$21){case 61:return Gen_util[5](prim);}
      ...
      case 122:
       ...
       switch(exit$22){case 63:return Gen_util[5](prim);}
      ...
      case 123:
       ...
       switch(exit$23){case 65:return Gen_util[5](prim);}
      ...
      case 124:
       ...
       switch(exit$24){case 67:return Gen_util[5](prim);}
      ...
      case 125:
       ...
       switch(exit$25){case 69:return Gen_util[5](prim);}
      ...
      case 126:
       ...
       switch(exit$26){case 71:return Gen_util[5](prim);}
      ...
      case 127:
       ...
       switch(exit$27){case 73:return Gen_util[5](prim);}
      ...
      case 128:
       ...
       switch(exit$28){case 75:return Gen_util[5](prim);}
      ...
      case 129:
       ...
       switch(exit$29){case 77:return Gen_util[5](prim);}
      ...
      case 130:
       ...
       switch(exit$30){case 79:return Gen_util[5](prim);}
      ...
      case 131:
       ...
       switch(exit$31){case 81:return Gen_util[5](prim);}
      ...
      case 132:
       ...
       switch(exit$32){case 93:return Gen_util[5](prim);}
      ...
      case 133:
       ...
       switch(exit$33){case 108:return Gen_util[5](prim);}
      ...
      case 136:
       ...
       if(args)
        {if(args[2]){exit$36=116;}else{return args[1];}}
       else
        {exit$36=116;}
       
       switch(exit$36){case 116:return Gen_util[5](prim);}
       
      case 137:return Gen_util[5](prim);
     ...
     {var match=l[1];
      ...
      switch(exit)
       {case 747:
        ...
        case 746:return flat_render(st,l[2]);
        }
      }
    else
     {return 0;}
       ...
       {var match=st[11];
        ...
        if(match)
         {var sp=match[1];
          ...
          switch(exit){case 728:if(match$2){}else{output(st,sp,1)}}
          }
        else
         {}
   ...
   {Pp[1](f,'"');
    ...
    for(var i=0;i<=l-1;i++)
     {var c=s[i];
      ...
      if(c>=34)
       {if(c!=92){if(c>=35){exit=593;}else{Pp[1](f,'\"')}}else{Pp[1](f,"\\")}}
      else
       {if(c!=10)
         {if(c>=32)
           {exit=593;}
      ...
      switch(exit){case 593:Pp[1](f,array_str1$1[c])}
      }
    ...
    switch(lam)
     {case 0:
      ...
      case 10:
       ...
       var $js$1;
       switch(exit$4){case 516:$js$1=/* tuple */[0,aux$2(st),0];}
       return Gen_util[14][1]
               (Gen_util[14][1]
      ...
      case 11:
       ...
       switch(exit$5){case 544:return /* tuple */[0,aux$3(st),0];}
     ...
     count=
      function(bv,param)
       {var exit;
        ...
        switch(param)
         {case 0:return use_var(bv,param[1],1);
          ...
          case 2:
           ...
           switch(exit$1)
            {case 638:count(bv,l1);return List["iter"](count(bv),param[2]);}
          ...
          case 8:
           ...
           if(d)
            {var d$1=d[1];
             ...
             switch(exit$3){case 633:return count(bv,d$1);}
             }
           else
            {return 0;}
        ...
        switch(exit)
         {case 640:return List["iter"](count(bv),param[2]);
          case 641:count(bv,param[1]);return count(bv,param[3]);
          }
        };
     ...
     mklet=
      function(param)
       {var e2=param[4];
        ...
        switch(exit){case 625:return /* Llet */[4,param[1],v,e1,e2];}
        };
                    ...
                    if(typeof match$5=="number")
                     ...
                     {switch(match$5[0])
                       {case 5:
                        ...
                        default:"unknown block:(exit 621)";}}
