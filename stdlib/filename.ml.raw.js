...
var
 temp_file=
  function(*opt*,prefix,suffix)
   {var $js$4=*opt*;
    if($js$4)
     {var *sth*=*opt*[1];var temp_dir=*sth*}
    else
...
var
 open_temp_file=
  function(*opt*,*opt*$1,prefix,suffix)
   {var $js$4=*opt*;
    if($js$4){var *sth*=*opt*[1];var mode=*sth*}else{var mode=[0,7,0]}
    var $js$5=*opt*$1;
    if($js$5)
     {var *sth*$1=*opt*$1[1];var temp_dir=*sth*$1}
    else
     {var temp_dir=current_temp_dir_name[1]}
    var
     try_name=
