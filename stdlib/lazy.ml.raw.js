 ...
 from_val=
  function(v)
   {var t="unknown primitive:caml_obj_tag";
    var
     $js=
      (t=Obj["forward_tag"])||(t=Obj["lazy_tag"])||(t=Obj["double_tag"]);
    if($js){return "unknown primitive:caml_lazy_make_forward"}else{return v}};
var
 is_val=
  function(l)
   {var $js="unknown primitive:caml_obj_tag";return $js!=Obj["lazy_tag"]};
