...
var
 pp_print_list=
  function(*opt*,pp_v,ppf,param)
   {var $js=*opt*;
    if($js){var *sth*=*opt*[1];var pp_sep=*sth*}else{var pp_sep=pp_print_cut}
    var $js$1=param;
    if($js$1)
     {var vs=param[2];
      var v=param[1];
       ...
       if($js$3==1)
        {var match=acc[2];
         ...
         if($js$4==0)
          {var acc'=match[1];
           output_acc(ppf,p$1);
           var $js$5=compute_tag(output_acc,acc');
          ...
          if($js$4==1)
           {var p$2=p$1;
            ...
            var $js$7=compute_tag(output_acc,acc'$1);
       ...
       if($js$3==1)
        {var match=acc[2];
         ...
         if($js$4==0)
          {var acc'=match[1];
           strput_acc(ppf,p$1);
           var $js$5=compute_tag(strput_acc,acc');
           return pp_open_tag(ppf,$js$5)}
         else
          if($js$4==1)
           {var p$2=p$1;
            ...
            var $js$6=CamlinternalFormat["open_box_of_string"];
            var $js$7=compute_tag(strput_acc,acc'$1);
            var match$2=$js$6($js$7);
            var bty=match$2[2];
            var indent=match$2[1];
            return pp_open_box_gen(ppf,indent,bty)}}
