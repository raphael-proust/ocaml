   ...
   {var char_set$prime=create_char_set(0);
    ...
    for(var i=$js;i<=$js$1;i++)
     {var $js$2=Pervasives["char_of_int"];
      ...
      var $js$5=$js$4^255;
      var $js$6=$js$2($js$5);
      char_set$prime[i]=$js$6,0}
    var $js$7=Bytes["unsafe_to_string"];
    return $js$7(char_set$prime)};
var
 is_in_char_set=
  function(char_set,c)
   {var ind=c;
               ...
               {var $js$19=$js$18[0];
                if($js$19==4)
                 {var fmtty_rest$7=match$17[1];
                  ...
                  return [0,
                          [6,iconv$2,pad$9,prec$5,fmt$prime$6],
                          fmtty$prime$6]}
                else
                 {var exit$5=290}}
                ...
                {var $js$22=$js$21[0];
                 if($js$22==5)
                  {var fmtty_rest$8=match$20[1];
                   ...
                   return [0,
                           [7,iconv$3,pad$11,prec$7,fmt$prime$7],
                           fmtty$prime$7]}
                 else
                  {var exit$6=291}}
                       ...
                       {var $js$34=$js$33[0];
                        if($js$34==9)
                         {var fmtty_rest$15=match$1[3];
                          ...
                          return [0,
                                  [14,pad_opt$1,sub_fmtty1,fmt$prime$14],
                                  fmtty$prime$14]}
                        else
                         {var exit=293}}}
                    else
                             ...
                             {var $js$52=$js$51[0];
                              if($js$52==1)
                               {var fmtty_rest$21=match$1[1];
                                ...
                                return [0,
                                        [20,width_opt,char_set,fmt$prime$19],
                                        fmtty$prime$19]}
                              else
                               {var exit=293}}}
                          else
                  ...
                  {var $js$24=$js$23[0];
                   if($js$24==9)
                    {var fmtty_rest$9=match$1[3];
                     ...
                     var $js$29=$js$28(sub1_fmtty$prime);
                     var $js$30=[0,$js$29];
                     var $js$31="unknown primitive:caml_notequal";
                     if($js$31){var $js$32=Type_mismatch;throw $js$32}else{}
                     ...
                     var $js$37=$js$36(sub2_fmtty$prime$1);
                     var $js$38=[0,$js$37];
                     var $js$39="unknown primitive:caml_notequal";
                     if($js$39){var $js$40=Type_mismatch;throw $js$40}else{}
                     var $js$41=symm(sub1_fmtty$prime);
                     var sub_fmtty$prime=trans($js$41,sub2_fmtty$prime$1);
                     ...
                     var $js$44=symm(sub_fmtty_rest$prime$9);
                     var $js$45=[9,sub1_fmtty$prime,sub2_fmtty$prime$1,$js$44];
                     return [0,$js$45,fmt$prime$9]}
                   else
                    {var exit=297}}}
               else
                if($js$2==10)
 ...
 make_padprec_fmt_ebb=
  function(pad,prec,fmt)
   {var match=make_precision_fmt_ebb(prec,fmt);
    ...
    var $js=pad;
    if(typeof $js=="number")
     {if($js==0){return [0,0,prec$1,fmt$prime]}}
    else
     {var $js$1=$js[0];
      if($js$1==0)
       {var w=pad[2];var s=pad[1];return [0,[0,s,w],prec$1,fmt$prime]}
      else
       if($js$1==1){var s$1=pad[1];return [0,[1,s$1],prec$1,fmt$prime]}}};
var
 fmt_ebb_of_string=
           ...
           {var $js$2=str_ind$1=end_ind$1;
            ...
            if($js$3)
             ...
             {var $js$5=(str_ind$1+1)=end_ind$1;
              ...
              var $js$6=c$prime$1!=37;
              if($js$6)
               {var $js$7=c$prime$1!=64;
                if($js$7)
