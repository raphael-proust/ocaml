...
var
 pad_of_pad_opt=
  function(pad_opt)
   {if(pad_opt){var width=pad_opt[1];return [0,1,width];}else{return 0;}};

var
 prec_of_prec_opt=
  function(prec_opt)
   {if(prec_opt){var ndec=prec_opt[1];return [0,ndec];}else{return 0;}};
   ...
   {if(typeof ign=="number")
     {switch(ign)
       {case 0:return [0,[0,fmt]];
        ...
        case 4:return [0,[22,fmt]];
        }}
    else
     {switch(ign[0])
       {case 0:var pad_opt=ign[1];return [0,[2,pad_of_pad_opt(pad_opt),fmt]];
        case 1:
         var pad_opt$1=ign[1];return [0,[3,pad_of_pad_opt(pad_opt$1),fmt]];
        case 2:
         var pad_opt$2=ign[2];
         
         var iconv=ign[1];
         
         return [0,[4,iconv,pad_of_pad_opt(pad_opt$2),0,fmt]];
        ...
        case 3:
         ...
         return [0,[5,iconv$1,pad_of_pad_opt(pad_opt$3),0,fmt]];
        ...
        case 4:
         ...
         return [0,[6,iconv$2,pad_of_pad_opt(pad_opt$4),0,fmt]];
        ...
        case 5:
         ...
         return [0,[7,iconv$3,pad_of_pad_opt(pad_opt$5),0,fmt]];
        ...
        case 10:var counter=ign[1];return [0,[21,counter,fmt]];
        }}
    };
...
var
 buffer_create=
  function(init_size){return [0,0,"unknown primitive:caml_create_string"];};
  ...
  function(iconv)
   {switch(iconv[0])
     {case 0:var exit=387;
      ...
      case 8:var exit=390;
      case 9:var exit=390;
      case 10:var exit=391;
      case 11:var exit=391;
      case 12:return 117;
      }
  ...
  function(fconv)
   {switch(fconv[0])
     {case 0:var exit=381;
      ...
      case 8:var exit=383;
      case 9:var exit=384;
      case 10:var exit=384;
      case 11:var exit=384;
      case 12:var exit=385;
      case 13:var exit=385;
      case 14:var exit=385;
      case 15:return 70;
      }
     ...
     print_start=
      function(set)
       {var
         is_alone=
          function(c)
           {var match=[0,Char["chr"](c-1),Char["chr"](c+1)];
       ...
       {var match=Pervasives["char_of_int"](i);
        ...
        if(!(48<switcher>>>0))
         {var switcher$1=-1+switcher;
          ...
          if(46<switcher$1>>>0){return print_out(set,i+1);}else{var exit=375;}
          }
        else
         {if(switcher>=210){return print_char(buf,255);}else{var exit=375;}}
  ...
  function(buf,iconv)
   {switch(iconv[0])
     {case 0:var exit=365;
      ...
      case 8:var exit=365;
      case 9:var exit=364;
      case 10:var exit=365;
      case 11:var exit=364;
      case 12:var exit=365;
      }
  ...
  function(buf,fconv)
   {switch(fconv[0])
     {case 0:var exit=358;
      ...
      case 8:var exit=357;
      case 9:var exit=358;
      case 10:var exit=356;
      case 11:var exit=357;
      case 12:var exit=358;
      case 13:var exit=356;
      case 14:var exit=357;
      case 15:var exit=358;
      }
   ...
   {if(typeof param=="number")
     ...
     {switch(param[0])
       {case 0:var rest=param[1];return [0,symm(rest)];
        case 1:var rest$1=param[1];return [1,symm(rest$1)];
        case 2:var rest$2=param[1];return [2,symm(rest$2)];
        case 3:var rest$3=param[1];return [3,symm(rest$3)];
        case 4:var rest$4=param[1];return [4,symm(rest$4)];
        case 5:var rest$5=param[1];return [5,symm(rest$5)];
        case 6:var rest$6=param[1];return [6,symm(rest$6)];
        case 7:var rest$7=param[1];return [7,symm(rest$7)];
        case 8:var rest$8=param[2];var ty=param[1];return [8,ty,symm(rest$8)];
        case 9:
         var rest$9=param[3];
         ...
         return [9,ty2,ty1,symm(rest$9)];
         
        case 10:var rest$10=param[1];return [10,symm(rest$10)];
        case 11:var rest$11=param[1];return [11,symm(rest$11)];
        case 12:var rest$12=param[1];return [12,symm(rest$12)];
        case 13:var rest$13=param[1];return [13,symm(rest$13)];
        case 14:var rest$14=param[1];return [14,symm(rest$14)];
        }}
    };
    ...
    if(typeof match=="number")
       ...
       {case 0:
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 8:var exit=335;
             case 9:var exit=333;
             case 10:var exit=345;
             case 11:var exit=343;
             case 12:var exit=341;
             case 13:var exit=339;
             case 14:var exit=337;
             default:
     ...
     {switch(match[0])
       {case 0:
         ...
         if(typeof match$1=="number")
          {switch(match$1){case 0:var exit=331;}}
         else
          {switch(match$1[0])
            {case 0:var rest2=match$1[1];return [0,trans(rest1,rest2)];
             case 8:var exit=335;
             case 9:var exit=333;
             case 10:var exit=345;
             case 11:var exit=343;
        ...
        case 1:
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 1:var rest2$1=match$1[1];return [1,trans(rest1$1,rest2$1)];
             case 8:var exit=335;
             case 9:var exit=333;
             case 10:var exit=345;
             case 11:var exit=343;
        ...
        case 2:
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 2:var rest2$2=match$1[1];return [2,trans(rest1$2,rest2$2)];
             case 8:var exit=335;
             case 9:var exit=333;
             case 10:var exit=345;
             case 11:var exit=343;
        ...
        case 3:
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 3:var rest2$3=match$1[1];return [3,trans(rest1$3,rest2$3)];
             case 8:var exit=335;
             case 9:var exit=333;
             case 10:var exit=345;
             case 11:var exit=343;
        ...
        case 4:
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 4:var rest2$4=match$1[1];return [4,trans(rest1$4,rest2$4)];
             case 8:var exit=335;
             case 9:var exit=333;
             case 10:var exit=345;
             case 11:var exit=343;
        ...
        case 5:
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 5:var rest2$5=match$1[1];return [5,trans(rest1$5,rest2$5)];
             case 8:var exit=335;
             case 9:var exit=333;
             case 10:var exit=345;
             case 11:var exit=343;
        ...
        case 6:
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 6:var rest2$6=match$1[1];return [6,trans(rest1$6,rest2$6)];
             case 8:var exit=335;
             case 9:var exit=333;
             case 10:var exit=345;
             case 11:var exit=343;
        ...
        case 7:
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 7:var rest2$7=match$1[1];return [7,trans(rest1$7,rest2$7)];
             case 8:var exit=335;
             case 9:var exit=333;
             case 10:var exit=345;
             case 11:var exit=343;
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 8:
              ...
              return [8,trans(ty1$1,ty2$1),trans(rest1$8,rest2$8)];
          ...
          {switch(match$1[0])
            {case 8:var exit=335;
             case 9:
              ...
              return [9,ty11,ty22,trans(rest1$9,rest2$9)];
        ...
        case 10:
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 10:
              var rest2$10=match$1[1];return [10,trans(rest1$10,rest2$10)];
             default:var exit$1=346;}}
        ...
        case 11:
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 10:var exit=345;
             case 11:
              var rest2$11=match$1[1];return [11,trans(rest1$11,rest2$11)];
             default:var exit=344;}}
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 10:var exit=345;
             case 11:var exit=343;
             case 12:
              var rest2$12=match$1[1];return [12,trans(rest1$12,rest2$12)];
             default:var exit=342;}}
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 10:var exit=345;
             ...
             case 12:var exit=341;
             case 13:
              var rest2$13=match$1[1];return [13,trans(rest1$13,rest2$13)];
             default:var exit=340;}}
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 10:var exit=345;
             ...
             case 13:var exit=339;
             case 14:
              var rest2$14=match$1[1];return [14,trans(rest1$14,rest2$14)];
             default:var exit=338;}}
 ...
 fmtty_of_fmt=
  function(fmtty)
   {if(typeof fmtty=="number")
     ...
     {switch(fmtty[0])
       {case 0:var rest=fmtty[1];return [0,fmtty_of_fmt(rest)];
        case 1:var rest$1=fmtty[1];return [0,fmtty_of_fmt(rest$1)];
        case 2:
         var rest$2=fmtty[2];
         
         var pad=fmtty[1];
         
         return fmtty_of_padding_fmtty(pad,[1,fmtty_of_fmt(rest$2)]);
        ...
        case 3:
         ...
         return fmtty_of_padding_fmtty(pad$1,[1,fmtty_of_fmt(rest$3)]);
        ...
        case 9:var rest$9=fmtty[1];return [7,fmtty_of_fmt(rest$9)];
        ...
        case 13:
         ...
         return [8,ty,fmtty_of_fmt(rest$13)];
        ...
        case 14:
         ...
         return [9,ty$1,ty$1,fmtty_of_fmt(rest$14)];
         
        case 15:var rest$15=fmtty[1];return [10,fmtty_of_fmt(rest$15)];
        case 16:var rest$16=fmtty[1];return [11,fmtty_of_fmt(rest$16)];
        ...
        case 19:var rest$19=fmtty[1];return [13,fmtty_of_fmt(rest$19)];
        case 20:var rest$20=fmtty[3];return [1,fmtty_of_fmt(rest$20)];
        case 21:var rest$21=fmtty[2];return [2,fmtty_of_fmt(rest$21)];
        case 22:var rest$22=fmtty[1];return [0,fmtty_of_fmt(rest$22)];
        case 23:
         var rest$23=fmtty[2];
...
var
 fmtty_of_custom=
  function(arity,fmtty)
   {if(arity)
     {var arity$1=arity[1];return [12,fmtty_of_custom(arity$1,fmtty)];}
    else
     {return fmtty;}
    };
   ...
   {if(typeof ign=="number")
     {switch(ign)
       {case 0:return fmtty_of_fmt(fmt);
        ...
        case 3:return [14,fmtty_of_fmt(fmt)];
 ...
 fmtty_of_padding_fmtty=
  function(pad,fmtty)
   {if(typeof pad=="number")
     ...
     {switch(pad[0]){case 0:return fmtty;case 1:return [2,fmtty];}}
    };
...
var
 fmtty_of_precision_fmtty=
  function(prec,fmtty)
   {if("unknown primitive:isint")
     {if(prec!=0){return [2,fmtty];}else{return fmtty;}}
    else
     {return fmtty;}
    };
 ...
 type_padding=
  function(pad,fmtty)
   {var match=pad;
    ...
    if(typeof match=="number")
     {switch(match){case 0:return [0,0,fmtty];}}
    else
     {switch(match[0])
       {case 0:var w=match[2];var padty=match[1];return [0,[0,padty,w],fmtty];
        case 1:
         if(typeof match$1=="number")
          {switch(match$1){}}
         else
 ...
 type_format_gen=
  function(fmt,fmtty)
   {var match=fmt;
    ...
    if(typeof match=="number")
     {switch(match){case 0:var fmtty_rest=match$1;return [0,0,fmtty_rest];}}
    else
     {switch(match[0])
       {case 0:
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 0:
              ...
              return [0,[0,fmt$prime],fmtty$prime];
              
             default:var exit=293;}}
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 0:
              ...
              return [0,[1,fmt$prime$1],fmtty$prime$1];
         ...
         if(typeof match$5=="number")
          ...
          {switch(match$5[0])
            {case 1:
              ...
              return [0,[2,pad$1,fmt$prime$2],fmtty$prime$2];
              
             default:var exit$1=286;}}
         ...
         if(typeof match$8=="number")
          ...
          {switch(match$8[0])
            {case 1:
              ...
              return [0,[3,pad$3,fmt$prime$3],fmtty$prime$3];
              
             default:var exit$2=287;}}
         ...
         if(typeof match$11=="number")
          ...
          {switch(match$11[0])
            {case 2:
              ...
              return [0,[4,iconv,pad$5,prec$1,fmt$prime$4],fmtty$prime$4];
              
             default:var exit$3=288;}}
         ...
         if(typeof match$14=="number")
          ...
          {switch(match$14[0])
            {case 3:
              ...
              return [0,[5,iconv$1,pad$7,prec$3,fmt$prime$5],fmtty$prime$5];
              
             default:var exit$4=289;}}
         ...
         if(typeof match$17=="number")
          ...
          {switch(match$17[0])
            {case 4:
              ...
              return [0,[6,iconv$2,pad$9,prec$5,fmt$prime$6],fmtty$prime$6];
              
             default:var exit$5=290;}}
         ...
         if(typeof match$20=="number")
          ...
          {switch(match$20[0])
            {case 5:
              ...
              return [0,[7,iconv$3,pad$11,prec$7,fmt$prime$7],fmtty$prime$7];
              
             default:var exit$6=291;}}
         ...
         if(typeof match$23=="number")
          ...
          {switch(match$23[0])
            {case 6:
              ...
              return [0,[8,fconv,pad$13,prec$9,fmt$prime$8],fmtty$prime$8];
              
             default:var exit$7=292;}}
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 7:
              ...
              return [0,[9,fmt$prime$9],fmtty$prime$9];
        ...
        case 10:
         ...
         return [0,[10,fmt$prime$10],fmtty$prime$10];
        ...
        case 11:
         ...
         return [0,[11,str,fmt$prime$11],fmtty$prime$11];
        ...
        case 12:
         ...
         return [0,[12,chr,fmt$prime$12],fmtty$prime$12];
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 8:
              ...
              return [0,
                      [13,pad_opt,sub_fmtty$prime,fmt$prime$13],
                      fmtty$prime$13];
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 9:
              ...
              return [0,[14,pad_opt$1,sub_fmtty1,fmt$prime$14],fmtty$prime$14];
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 10:
              ...
              return [0,[15,fmt$prime$15],fmtty$prime$15];
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 11:
              ...
              return [0,[16,fmt$prime$16],fmtty$prime$16];
        ...
        case 17:
         ...
         return [0,[17,formatting_lit,fmt$prime$17],fmtty$prime$17];
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 13:
              ...
              return [0,[19,fmt$prime$18],fmtty$prime$18];
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 1:
              ...
              return [0,[20,width_opt,char_set,fmt$prime$19],fmtty$prime$19];
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 2:
              ...
              return [0,[21,counter,fmt$prime$20],fmtty$prime$20];
              
             default:var exit=293;}}
         
        case 22:var exit=293;
        case 23:
         ...
         if(typeof fmtty=="number")
          ...
          {switch(fmtty[0])
            {case 14:
              ...
              return [0,[23,3,fmt$prime],fmtty$prime];
              
             default:var exit=294;}}
     ...
     {switch(ign[0])
       {case 0:
        ...
        case 8:
         ...
         return [0,
                 [23,[8,pad_opt$1,sub_fmtty$prime],fmt$prime$1],
                 fmtty$prime$1];
 ...
 type_ignored_param_one=
  function(ign,fmt,fmtty)
   {var match=type_format_gen(fmt,fmtty);
    ...
    return [0,[23,ign,fmt$prime],fmtty$prime];
    };
 ...
 type_ignored_format_substitution=
  function(sub_fmtty,fmt,fmtty)
   {var match=sub_fmtty;
    ...
    if(typeof match=="number")
     {switch(match)
       {case 0:var fmtty$1=match$1;return [0,0,type_format_gen(fmt,fmtty$1)];}}
    else
     {switch(match[0])
       {case 0:
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 0:
              ...
              return [0,[0,sub_fmtty_rest$prime],fmt$prime];
              
             default:var exit=297;}}
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 1:
              ...
              return [0,[1,sub_fmtty_rest$prime$1],fmt$prime$1];
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 2:
              ...
              return [0,[2,sub_fmtty_rest$prime$2],fmt$prime$2];
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 3:
              ...
              return [0,[3,sub_fmtty_rest$prime$3],fmt$prime$3];
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 4:
              ...
              return [0,[4,sub_fmtty_rest$prime$4],fmt$prime$4];
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 5:
              ...
              return [0,[5,sub_fmtty_rest$prime$5],fmt$prime$5];
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 6:
              ...
              return [0,[6,sub_fmtty_rest$prime$6],fmt$prime$6];
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 7:
              ...
              return [0,[7,sub_fmtty_rest$prime$7],fmt$prime$7];
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 8:
              ...
              return [0,
                      [8,sub2_fmtty$prime,sub_fmtty_rest$prime$8],
                      fmt$prime$8];
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 10:
              ...
              return [0,[10,sub_fmtty_rest$prime$10],fmt$prime$10];
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 11:
              ...
              return [0,[11,sub_fmtty_rest$prime$11],fmt$prime$11];
              
             default:var exit=297;}}
         
        case 12:var exit=297;
        case 13:
         if(typeof match$1=="number")
          {switch(match$1){}}
         else
          {switch(match$1[0])
            {case 13:
              ...
              return [0,[13,sub_fmtty_rest$prime$12],fmt$prime$12];
         ...
         if(typeof match$1=="number")
          ...
          {switch(match$1[0])
            {case 14:
              ...
              return [0,[14,sub_fmtty_rest$prime$13],fmt$prime$13];
 ...
 fix_padding=
  function(padty,width,str)
   {var len=str["length"];
    ...
    var match=[0,Pervasives["abs"](width),width<0?0:padty];
    ...
    if(c>=58)
     {if(c>=71)
       {var switcher=-97+c;
        ...
        if(5<switcher>>>0){var exit=274;}else{var exit=276;}
        }
      else
       {if(c>=65){var exit=276;}else{var exit=274;}}
      }
    else
     {if(c!=32)
       {if(c>=43)
         {var switcher$1=-43+c;
          ...
          switch(switcher$1[0])
           {case 0:var exit=275;
            ...
            case 12:var exit=276;
            case 13:var exit=276;
            case 14:var exit=276;
            }
          }
        else
         {var exit=274;}
...
var
 string_to_caml_string=
  function(str)
   {return $$String["concat"]($$String["escaped"](str),[0,'"',[0,'"',0]]);};
           ...
           {var match=str[i];
            ...
            if(!(23<switcher>>>0))
             {var switcher$1=-1+switcher;
              ...
              if(21<switcher$1>>>0){var exit=253;}else{var exit=254;}
              }
            else
             {if(switcher!=55){var exit=254;}else{var exit=253;}}
...
var
 format_caml_char=
  function(c)
   {return $$String["concat"](Char["escaped"](c),[0,"'",[0,"'",0]]);};
     ...
     {switch(fmt[0])
       {case 0:
        ...
        case 1:
         ...
         return function(c)
          {var new_acc=[4,acc,format_caml_char(c)];
        ...
        case 9:
         ...
         return function(b)
          {return make_printf
                   (k,o,[4,acc,Pervasives["string_of_bool"](b)],rest$9);
           };
         
        case 10:var rest$10=fmt[1];return make_printf(k,o,[7,acc],rest$10);
        case 11:
         var rest$11=fmt[2];
        ...
        case 13:
         ...
         return function(str$1){return make_printf(k,o,[4,acc,ty],rest$13);};
        ...
        case 16:
         ...
         return function(f){return make_printf(k,o,[6,acc,f],rest$16);};
        ...
        case 18:
         ...
         switch(match)
          {case 0:
            ...
            return make_printf(k$prime,o,0,fmt$prime);
           ...
           case 1:
            ...
            return make_printf(k$prime$1,o,0,fmt$prime$1);
        ...
        case 21:
         ...
         return function(n)
          {var new_acc$1=[4,acc,"unknown primitive:caml_format_int"];
   ...
   {if(typeof pad=="number")
     ...
     {switch(pad[0])
       {case 0:
         ...
         return function(x)
          {var new_acc=[4,acc,fix_padding(padty,width,trans$1(x))];
        ...
        case 1:
         ...
         return function(w,x)
          {var new_acc=[4,acc,fix_padding(padty$1,w,trans$1(x))];
          ...
          {if(match$1!=0)
            ...
            {return function(x)
              {var str=convert_float(fconv,default_float_precision,x);
               ...
               return make_printf(k,o,[4,acc,str$prime],fmt);
               };
             }
           }
         else
   ...
   {if("unknown primitive:caml_string_equal")
     ...
     {var len=str["length"];
        ...
        function(i)
         {if(i=len)
           ...
           {var match=str[i];
            ...
            if(match!=9)
             {if(match!=32){return i;}else{var exit=190;}}
            else
             {var exit=190;}
        ...
        function(i,j)
         {if(j=len)
           ...
           {var match=str[j];
            ...
            if(match>=48)
             {if(match>=58){var exit=195;}else{var exit=194;}}
            else
             {if(match!=45){var exit=195;}else{var exit=194;}}
      ...
      switch(box_name)
       {case "":var exit=178;
        case "b":var exit=178;
        case "h":var box_type=0;
        case "hov":var box_type=3;
        case "hv":var box_type=2;
        case "v":var box_type=1;
        default:var exit=179;}
...
var
 make_padding_fmt_ebb=
  function(pad,fmt)
   {if(typeof pad=="number")
     {switch(pad){case 0:return [0,0,fmt];}}
    else
     {switch(pad[0])
       {case 0:var w=pad[2];var s=pad[1];return [0,[0,s,w],fmt];
        case 1:var s$1=pad[1];return [0,[1,s$1],fmt];
        }}
    };
...
var
 make_precision_fmt_ebb=
  function(prec,fmt)
   {if("unknown primitive:isint")
     {if(prec!=0){return [0,1,fmt];}else{return [0,0,fmt];}}
    else
 ...
 make_padprec_fmt_ebb=
  function(pad,prec,fmt)
   {var match=make_precision_fmt_ebb(prec,fmt);
    ...
    if(typeof pad=="number")
     {switch(pad){case 0:return [0,0,prec$1,fmt$prime];}}
    else
     {switch(pad[0])
       {case 0:var w=pad[2];var s=pad[1];return [0,[0,s,w],prec$1,fmt$prime];
        case 1:var s$1=pad[1];return [0,[1,s$1],prec$1,fmt$prime];
        }}
    };
      ...
      function(pct_ind,str_ind,end_ind,zero,minus,plus,sharp,space,ign)
       {if(str_ind=end_ind){unexpected_end_of_format(end_ind)}else{}
        ...
        if(match!=0)
         ...
         {if(match$1!=0){var padty=0;}else{var padty=1;}}
       ...
       {if(str_ind=end_ind){unexpected_end_of_format(end_ind)}else{}
        ...
        if(symb>=48)
         {if(symb>=58)
           ...
           {return parse_literal$1(minus,str_ind);}
          }
        else
         {if(symb>=42)
       ...
       {if(str_ind=end_ind){unexpected_end_of_format(end_ind)}else{}
        ...
        if("unknown primitive:isint")
         {var match=minus;
          ...
          if("unknown primitive:isint")
           {if(match$1!=0){var exit=24;}else{return parse_conv(0);}}
          else
           {var exit=24;}
     ...
     parse_conversion=
      function
       ...
       {var plus_used=[0,0];
               ...
               {case 0:
                 ...
                 switch(match[0])
                  {case 0:
                   ...
                   case 1:var width$1=pad$1[2];return [0,width$1];
                   case 2:
                    var width$2=pad$1[2];
        ...
        var get_padprec_opt=function(c){return opt_of_pad(c,get_padprec(0));};
         ...
         {switch(symb[0])
           {case 0:var exit=63;
            ...
            case 40:
             ...
             if(get_ign(0))
              {var ignored=[8,get_pad_opt(95),sub_fmtty];
               
               var fmt_result=[0,[23,ignored,fmt_rest$1]];
               }
             else
              {var fmt_result=[0,[14,get_pad_opt(40),sub_fmtty,fmt_rest$1]];}
            ...
            case 83:
             ...
             if(get_ign(0))
              {var ignored$2=[1,get_padprec_opt(95)];
              ...
              {var match$6=make_padding_fmt_ebb(pad$1,fmt_rest$4);
               ...
               var fmt_result=[0,[3,pad$prime,fmt_rest$prime]];
               }
            ...
            case 91:
             ...
             if(get_ign(0))
              {var ignored$3=[9,get_pad_opt(95),char_set];
               
               var fmt_result=[0,[23,ignored$3,fmt_rest$5]];
               }
             else
              {var fmt_result=[0,[20,get_pad_opt(91),char_set,fmt_rest$5]];}
            ...
            case 100:var exit=64;
            case 101:var exit=66;
            case 102:var exit=66;
            case 103:var exit=66;
            case 104:var exit=63;
            case 105:var exit=64;
            case 106:var exit=63;
            case 107:var exit=63;
            case 108:var exit=65;
            case 109:var exit=63;
            case 110:var exit=65;
            case 111:var exit=64;
            case 112:var exit=63;
            case 113:var exit=63;
            case 114:
            ...
            case 115:
             ...
             if(get_ign(0))
              {var ignored$4=[0,get_padprec_opt(95)];
              ...
              {var match$14=make_padding_fmt_ebb(pad$2,fmt_rest$9);
               ...
               var fmt_result=[0,[2,pad$prime$1,fmt_rest$prime$1]];
               }
            ...
            case 117:var exit=64;
            case 118:var exit=63;
            case 119:var exit=63;
            case 120:var exit=64;
            case 121:var exit=63;
            case 122:var exit=63;
            case 123:
             ...
             if(get_ign(0))
              {var ignored$5=[7,get_pad_opt(95),sub_fmtty$1];
              ...
              {var
                fmt_result=
                 [0,[13,get_pad_opt(123),sub_fmtty$1,fmt_rest$11]];
               }
        ...
        switch(exit)
         {case 64:
           ...
           if(get_ign(0))
            {var ignored$6=[2,iconv,get_pad_opt(95)];
            ...
            {var match$19=get_pad(0);
             ...
             switch(exit$1)
              {case 36:
                if(typeof match$21=="number")
                 {switch(match$21){case 0:var pad$4=0;}}
                else
                 {switch(match$21[0])
                   {case 0:
             ...
             var match$25=make_padprec_fmt_ebb(pad$4,get_prec(0),fmt_rest$12);
             ...
             var
              fmt_result=
               [0,[4,iconv,pad$prime$2,prec$prime,fmt_rest$prime$2]];
             }
          ...
          case 66:
           var
            fconv=
             compute_float_conv(pct_ind,str_ind,get_plus(0),get_space(0),symb);
           ...
           if(get_ign(0))
            {var ignored$8=[6,get_pad_opt(95),get_prec_opt(0)];
            ...
            {var
              match$28=
               make_padprec_fmt_ebb(get_pad(0),get_prec(0),fmt_rest$14);
             ...
             var
              fmt_result=
               [0,[8,fconv,pad$prime$3,prec$prime$1,fmt_rest$prime$3]];
             }
           ...
           if(symb>=108)
              ...
              {var switcher=-108+symb;
               ...
               switch(switcher[0])
                {case 0:
                  ...
                  if(get_ign(0))
                   {var ignored$9=[3,iconv$1,get_pad_opt(95)];
                   ...
                   {var
                     match$32=
                      make_padprec_fmt_ebb(get_pad(0),get_prec(0),fmt_rest$17);
                    ...
                    var
                     fmt_result=
                      [0,[5,iconv$1,pad$prime$4,prec$prime$2,fmt_rest$prime$4]];
                    }
                 ...
                 case 2:
                  ...
                  if(get_ign(0))
                   {var ignored$10=[4,iconv$2,get_pad_opt(95)];
                   ...
                   {var
                     match$34=
                      make_padprec_fmt_ebb(get_pad(0),get_prec(0),fmt_rest$18);
                    ...
                    var
                     fmt_result=
                      [0,[6,iconv$2,pad$prime$5,prec$prime$3,fmt_rest$prime$5]];
                    }
            ...
            {if(symb!=76)
              ...
              {var
               ...
               if(get_ign(0))
                {var ignored$11=[5,iconv$3,get_pad_opt(95)];
                ...
                {var
                  match$36=
                   make_padprec_fmt_ebb(get_pad(0),get_prec(0),fmt_rest$19);
                 ...
                 var
                  fmt_result=
                   [0,[7,iconv$3,pad$prime$6,prec$prime$4,fmt_rest$prime$6]];
                 }
               }
             }
        ...
        if(!ign_used[1]&&ign)
         {if(symb>=38)
           {if(symb!=44)
             {if(symb!=64){var exit$2=27;}else{var exit$2=28;}}
            else
             {var exit$2=28;}
            }
          else
           {if(symb!=33)
             {if(symb>=37){var exit$2=28;}else{var exit$2=27;}}
            else
             {var exit$2=28;}
            }
           ...
           {if(c>=94)
             {var switcher=-123+c;
              ...
              if(2<switcher>>>0)
               ...
               {switch(switcher[0])
                 {case 0:return parse_tag(1,str_ind+1,end_ind);
                  case 1:var exit=91;
                  case 2:
             ...
             {if(c>=91)
               {var switcher$1=-91+c;
                ...
                switch(switcher$1[0])
                 {case 0:return parse_tag(0,str_ind+1,end_ind);
                  case 1:var exit=91;
                  case 2:
             ...
             if("unknown primitive:isint")
              {var str$1=fmt[1];
               ...
               try
                ...
                {var tag=exn[1];if(tag=Failure){return 0;}else{throw exn;}}
               }
             else
              {var exit=93;}
      ...
      function(str_ind,end_ind)
       {try
         {if((str_ind=end_ind)||str[str_ind]!=60){throw Not_found;}else{}
          ...
          if(match>=48)
           {if(match>=58){var exit=114;}else{var exit=113;}}
          else
           {if(match!=45){var exit=114;}else{var exit=113;}}
         ...
         {if(exn=Not_found)
           ...
           {var tag=exn[1];if(tag=Failure){var exit$2=103;}else{throw exn;}}
      ...
      function(str_ind,end_ind)
       {try
         {var str_ind_1=parse_spaces(str_ind,end_ind);
          ...
          if(match>=48)
           {if(match>=58){var exit=124;}else{var exit=123;}}
          else
           {if(match!=45){var exit=124;}else{var exit=123;}}
         ...
         {if(exn=Not_found)
           ...
           {var tag=exn[1];if(tag=Failure){var exit$1=118;}else{throw exn;}}
     ...
     parse_char_set=
      function(str_ind,end_ind)
       {if(str_ind=end_ind){unexpected_end_of_format(end_ind)}else{}
        ...
        if(match!=94)
         {var match$1=[0,str_ind,0];}
        else
         {var match$1=[0,str_ind+1,1];}
        ...
        return [0,next_ind,reverse?rev_char_set(char_set$1):char_set$1];
        };
     ...
     add_literal=
      function(lit_start,str_ind,fmt)
       {var size=str_ind-lit_start;
        ...
        if(size!=0)
         {if(size!=1)
           {return [0,[11,$$String["sub"](str,lit_start,size),fmt]];}
          else
           {return [0,[12,str[lit_start],fmt]];}
          }
        else
         {return [0,fmt];}
        };
        ...
        if(32<switcher>>>0)
         ...
         {switch(switcher[0])
           {case 0:var exit=157;
            ...
            case 8:var exit=158;
            case 9:var exit=158;
            case 10:var exit=158;
            case 11:var exit=158;
            case 12:var exit=157;
            case 13:var exit=158;
            case 14:var exit=158;
            case 15:var exit=158;
            case 16:var exit=158;
            case 17:var exit=157;
            case 18:var exit=158;
            case 19:var exit=158;
            case 20:var exit=158;
            case 21:var exit=158;
            case 22:var exit=158;
            case 23:var exit=157;
            case 24:var exit=158;
            case 25:var exit=158;
            case 26:var exit=158;
            case 27:var exit=158;
            case 28:var exit=158;
            case 29:var exit=157;
            case 30:var exit=158;
            case 31:var exit=158;
            case 32:var exit=157;
            }
          }
       ...
       {if(symb>=108)
         {if(symb>=111)
           ...
           {var switcher=-108+symb;
            ...
            switch(switcher[0])
             {case 0:return 0;case 1:var exit=159;case 2:return 1;}
            }
          }
        else
         {if(symb!=76){var exit=159;}else{return 2;}}
        ...
        if(match!=0)
         {if(match$1!=0)
           ...
           {if(match$2!=0)
             ...
             {if(match$3!=100)
               {if(match$3!=105){var exit=160;}else{return 4;}}
              else
               {return 1;}
              }
            }
         ...
         {if(match$1!=0)
           {if(match$2!=0)
             ...
             {if(match$3!=88)
               {if(match$3!=111)
                 {if(match$3!=120){var exit=161;}else{return 7;}}
                else
                 {return 11;}
                }
              else
           ...
           {if(match$2!=0)
             {if(match$3!=100)
               {if(match$3!=105){var exit=160;}else{return 5;}}
              else
               {return 2;}
              }
            else
              ...
              if(32<switcher>>>0)
               ...
               {switch(switcher[0])
                 {case 0:return 8;
                  ...
                  case 8:var exit=160;
                  case 9:var exit=160;
                  case 10:var exit=160;
                  case 11:var exit=160;
                  case 12:return 0;
                  case 13:var exit=160;
                  case 14:var exit=160;
                  case 15:var exit=160;
                  case 16:var exit=160;
                  case 17:return 3;
                  case 18:var exit=160;
                  case 19:var exit=160;
                  case 20:var exit=160;
                  case 21:var exit=160;
                  case 22:var exit=160;
                  case 23:return 10;
                  case 24:var exit=160;
                  case 25:var exit=160;
                  case 26:var exit=160;
                  case 27:var exit=160;
                  case 28:var exit=160;
                  case 29:return 12;
                  case 30:var exit=160;
                  case 31:var exit=160;
                  case 32:return 6;
                  }
                }
              }
           ...
           {if(match$2>=72)
             {var switcher=-101+match$2;
              ...
              if(2<switcher>>>0)
               ...
               {switch(switcher[0])
                 {case 0:return 4;case 1:return 1;case 2:return 10;}
                }
              }
            else
             {if(match$2>=69)
               {var switcher$1=-69+match$2;
                ...
                switch(switcher$1[0])
                 {case 0:return 7;case 1:var exit=164;case 2:return 13;}
                }
              else
               {var exit=164;}
              }
           ...
           {if(match$2>=72)
             {var switcher$2=-101+match$2;
              ...
              if(2<switcher$2>>>0)
               ...
               {switch(switcher$2[0])
                 {case 0:return 5;case 1:return 2;case 2:return 11;}
                }
              }
            else
             {if(match$2>=69)
               {var switcher$3=-69+match$2;
                ...
                switch(switcher$3[0])
                 {case 0:return 8;case 1:var exit$1=165;case 2:return 14;}
                }
              else
               {var exit$1=165;}
              }
           ...
           {if(match$2>=72)
             {var switcher$4=-101+match$2;
              ...
              if(2<switcher$4>>>0)
               ...
               {switch(switcher$4[0])
                 {case 0:return 3;case 1:return 0;case 2:return 9;}
                }
              }
            else
             {if(match$2>=69)
               {var switcher$5=-69+match$2;
                ...
                switch(switcher$5[0])
                 {case 0:return 6;case 1:return 15;case 2:return 12;}
                }
              else
               {var exit$2=166;}
              }
 ...
 format_of_string_fmtty=
  function(str,fmtty)
   {var match=fmt_ebb_of_string(0,str);
    ...
    try
     {return [0,type_format(fmt,fmtty),str];}
    catch(exn)
 ...
 format_of_string_format=
  function(str,param)
   {var str$prime=param[2];
    ...
    try
     {return [0,type_format(fmt,fmtty_of_fmt(fmt$prime)),str];}
    catch(exn)
     {if(exn=Type_mismatch)
       {return failwith_message
                ([0,
