...
var
 bool_of_string=
  function(param)
   {switch(param)
     {case "false":return 0;case "true":return 1;default:var exit=66;}
      ...
      function(i)
       {if(i>=l)
         ...
         {var match$1=s[i];
          ...
          if(match$1>=48)
           {if(match$1>=58){var exit=62;}else{var exit=61;}}
          else
           {if(match$1!=45){var exit=62;}else{var exit=61;}}
...
[0,
 ...
 open_out_bin,
 open_out_gen,
 function(prim){return "unknown primitive:caml_ml_flush";},
 flush_all,
 function(prim,prim$1){return "unknown primitive:caml_ml_output_char";},
 output_string,
 output_bytes,
 output,
 output_substring,
 function(prim,prim$1){return "unknown primitive:caml_ml_output_char";},
 function(prim,prim$1){return "unknown primitive:caml_ml_output_int";},
 output_value,
 function(prim,prim$1){return "unknown primitive:caml_ml_seek_out";},
