       ...
       {var c$1=s[i$1];
        ...
        if($js$14)
         {var switcher$1=-1+switcher;
          ...
          if($js$15){s'[n[1]]=92,0;n[0]++;s'[n[1]]=c$1,0}else{var exit$1=27}}
        else
                 ...
                 if($js$18==5)
                  ...
                  if($js$18==6)
                   ...
                   if($js$18==7)
                    ...
                    if($js$18==8)
                     {s'[n[1]]=92,0;n[0]++;s'[n[1]]=98,0}
                    else
                     if($js$18==9)
                      {s'[n[1]]=92,0;n[0]++;s'[n[1]]=116,0}
                     else
                      if($js$18==10)
                       {s'[n[1]]=92,0;n[0]++;s'[n[1]]=110,0}
                      else
                       if($js$18==11)
                        {var exit$1=27}
                       else
                        if($js$18==12)
                         ...
                         if($js$18==13){s'[n[1]]=92,0;n[0]++;s'[n[1]]=114,0}}}
        switch(exit$1)
         {case 27:
           var c$2=c$1;
